...
while ($row = mysqli_fetch_assoc($user_query)) {
	...
	// ###############################code for current month ######################################################		 
			...
			$stmt = "SELECT vl.call_date,vl.length_in_sec,vl.status,vl.user,vu.full_name,vl.campaign_id,vi.vendor_lead_code,vi.source_id,vi.list_id,vi.gmt_offset_now,vi.phone_code,vi.phone_number,vi.title,vi.first_name,vi.middle_initial,vi.last_name,vi.address1,vi.address2,vi.address3,vi.city,vi.state,vi.province,vi.postal_code,vi.country_code,vi.gender,vi.date_of_birth,vi.alt_phone,vi.email,vi.security_phrase,vl.custom_comment,vl.length_in_sec,vl.user_group,vl.alt_dial,vi.rank,vi.owner,vi.lead_id,vl.uniqueid,vi.entry_list_id,UNIX_TIMESTAMP(vl.call_date)$export_fields_SQL,vl.field1,vl.field2,vl.field3,vl.field4,vl.field5,vl.field6,vl.field7,vl.field8,vl.field9,vl.field10,vl.field11,vl.field12,vl.field13,vl.field14,vl.field15,vl.field16,vl.field17,vl.field18,vl.field19,vl.field20,vl.field21,vl.field22,vl.field23,vl.field24,vl.field25,vl.field26,vl.field27,vl.field28,vl.field29,vl.field30,vl.field31,vl.field32,vl.field33,vl.field34,vl.field35,vl.field36,vl.field37,vl.field38,vl.field39,vl.field40,vl.phone_number from vicidial_users vu,vicidial_log vl,vicidial_list vi where vl.call_date >= '$query_date 00:00:00' and vl.call_date <= '$end_date 23:59:59' and vu.user=vl.user and vi.lead_id=vl.lead_id $list_SQL $campaign_SQL $user_group_SQL $status_SQL order by vl.call_date desc limit 500000;";
	//	echo $stmt;exit;
                $rslt=mysql_to_mysqli($stmt, $link);
		if ($DB) {echo "$stmt\n";}
...
$row[79] = str_replace(',', '', $row[79]);
				...
				$export_rows.= "$row[0],$row[1],$row[79],$row[2],$row[3],$row[4],$row[5],Outbound,$row[6],$row[7],$row[8],$row[9],$row[10],$row[11],$row[12],$row[13],$row[14],$row[15],$row[16],$row[17],$row[18],$row[19],$row[20],$row[21],$row[22],$row[23],$row[24],$row[25],$row[26],$row[27],$row[28],$row[29],$row[39],$row[40],$row[41],$row[42],$row[43],$row[44],$row[45],$row[46],$row[47],$row[48],$row[49],$row[50],$row[51],$row[52],$row[53],$row[54],$row[55],$row[56],$row[57],$row[58],$row[59],$row[60],$row[61],$row[62],$row[63],$row[64],$row[65],$row[66],$row[67],$row[68],$row[69],$row[70],$row[71],$row[72],$row[73],$row[74],$row[75],$row[76],$row[77],$row[78],$row[31],$row[32],$row[33],$row[34],$row[35],$export_fieldsDATA***";
...
//die;
	if ($RUNgroup > 0)
		...
		$stmtA = "SELECT vl.call_date,length_in_sec,vl.status,vl.user,vu.full_name,vl.campaign_id,vi.vendor_lead_code,vi.source_id,vi.list_id,vi.gmt_offset_now,vi.phone_code,vi.phone_number,vi.title,vi.first_name,vi.middle_initial,vi.last_name,vi.address1,vi.address2,vi.address3,vi.city,vi.state,vi.province,vi.postal_code,vi.country_code,vi.gender,vi.date_of_birth,vi.alt_phone,vi.email,vi.security_phrase,vl.custom_comment,vl.length_in_sec,vl.user_group,vl.queue_seconds,vi.rank,vi.owner,vi.lead_id,vl.closecallid,vi.entry_list_id,vl.uniqueid,UNIX_TIMESTAMP(vl.call_date)$export_fields_SQL,vl.field1,vl.field2,vl.field3,vl.field4,vl.field5,vl.field6,vl.field7,vl.field8,vl.field9,vl.field10,vl.field11,vl.field12,vl.field13,vl.field14,vl.field15,vl.field16,vl.field17,vl.field18,vl.field19,vl.field20,vl.field21,vl.field22,vl.field23,vl.field24,vl.field25,vl.field26,vl.field27,vl.field28,vl.field29,vl.field30,vl.field31,vl.field32,vl.field33,vl.field34,vl.field35,vl.field36,vl.field37,vl.field38,vl.field39,vl.field40,vl.phone_number from vicidial_users vu,vicidial_closer_log vl,vicidial_list vi where vl.call_date >= '$query_date 00:00:00' and vl.call_date <= '$end_date 23:59:59' and vu.user=vl.user and vi.lead_id=vl.lead_id $list_SQL $group_SQL $user_group_SQL $status_SQL order by vl.call_date desc limit 500000;";
...
$row[79] = str_replace(',', '', $row[79]);
	...
	$export_rows[$k] = "$row[0],$row[1],$row[80],$row[2],$row[3],$row[4],$row[5],Inbound,$row[6],$row[7],$row[8],$row[9],$row[10],$row[11],$row[12],$row[13],$row[14],$row[15],$row[16],$row[17],$row[18],$row[19],$row[20],$row[21],$row[22],$row[23],$row[24],$row[25],$row[26],$row[27],$row[28],$row[29],$row[39],$row[40],$row[41],$row[42],$row[43],$row[44],$row[45],$row[46],$row[47],$row[48],$row[49],$row[50],$row[51],$row[52],$row[53],$row[54],$row[55],$row[56],$row[57],$row[58],$row[59],$row[60],$row[61],$row[62],$row[63],$row[64],$row[65],$row[66],$row[67],$row[68],$row[69],$row[70],$row[71],$row[72],$row[74],$row[75],$row[76],$row[77],$row[78],$row[79],$row[31],$row[32],$row[33],$row[34],$row[35],$export_fieldsDATA"
;
	//$export_rows.  = "$row[0],$row[1],$row[79],$row[2],$row[3],$row[4],$row[5],Outbound,$row[6],$row[7],$row[8],$row[9],$row[10],$row[11],$row[12],$row[13],$row[14],$row[15],$row[16],$row[17],$row[18],$row[19],$row[20],$row[21],$row[22],$row[23],$row[24],$row[25],$row[26],$row[27],$row[28],$row[29],$row[39],$row[40],$row[41],$row[42],$row[43],$row[44],$row[45],$row[46],$row[47],$row[48],$row[49],$row[50],$row[51],$row[52],$row[53],$row[54],$row[55],$row[56],$row[57],$row[58],$row[59],$row[60],$row[61],$row[62],$row[63],$row[64],$row[65],$row[66],$row[67],$row[68],$row[69],$row[70],$row[71],$row[72],$row[73],$row[74],$row[75],$row[76],$row[77],$row[78],$row[31],$row[32],$row[33],$row[34],$row[35],$export_fieldsDATA***";
	...
	if ( ($outbound_to_print > 0) or ($inbound_to_print > 0) )
		...
		while ($k > $i)
			...
			asort($RAW_EXPORT);
	$RAW_EXPORT = array_values($RAW_EXPORT);
