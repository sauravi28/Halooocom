...
if(isset($_POST['confdelete_submit'])){ //check if form was submitted
 
  $fdb_idd = $_POST['fdb_idd']; //get input text
 
  //$sql_queryd = "delete from voicefiles where id = $fdb_idd";
  //$resultd = mysqli_query($db,$sql_queryd);
  
  $update_value = "update voicefiles set deleted = '1' where id = '$fdb_idd'"; 
  mysqli_query($db,$update_value);
...
function adddelete(val){
	//alert(val);
	document.getElementById('fdb_idd').value=val;
		// Get the modal
 ...
 <!-- Modal content add -->
  ...
  <source src="horse.ogg" type="audio/ogg">
	  ...
	  <hr>  <hr> 
	   ...
	   <p><div id="myModal12" class="modal12">
 <!-- Modal content add -->
  <div class="modal-content1"  align = "center">
      <span class="close2">&times;</span>
	  <h4 class="h4class" >DELETE RECORDING</h4>
	  <hr>
	  
	  <form action="" method="POST">
					    <div>	
							<span style="color:white"><b>RECORDING-ID</b></span>					   
							<input type="text" name="fdb_idd"  class="inputText"  id="fdb_idd" readonly>
						</div>	
						<br>
						<div align = "center">
						<!--<input type="submit" value="DELETE" name="confdelete_submit" class = "btn">-->
						<button type="submit" name = "confdelete_submit" data-toggle="tooltip" class = "btn1" data-placement="right" title="DELETE">DELETE</button>
						</div>
					   </form>
