...
$stmt="SELECT end_date FROM vicidial_expiry_date where payment_status = 'Unpaid'";
//echo $stmt;
//die;
...
$date2 = $sla_expiry;
	...
	array_push($date_def, $value->format('Y-m-d'));	
  ...
  <div class="content-wrapper" id = "content_loading">
	...
	<br>
	 <?php if($sla_expiry !='' && $sla_expiry != '0000-00-00' ){ ?>
	    <marquee bgcolor='#1A2B6D' font style='bold;position:absolute;z-index:1030;' scrolldealy: default(85);><font size='5' face='auto'><font color='#D8BFD8'><?php if($date_def[0] ==$today || $date_def[1] ==$today || $date_def[2] ==$today || $date_def[3] ==$today || $date_def[4] ==$today){ echo "Note: Please clear the due amount for uninterrupted service.. ";} ?>
		</marquee> <br>
	<?php } ?>
    <!-- Main content -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Agent Information<span style = "color: blue" id = "displayUserDetails"><?php ?></span></h3>
...
var loginUser = '<?php echo $superAdminLoginUser; ?>';
		...
		function agentLiveData(){  
		  ...
		  xhttp.open("GET", "ajax/superAdmin.php?loginUser="+loginUser, true);
		  xhttp.send();
		}
		agentLiveData();
