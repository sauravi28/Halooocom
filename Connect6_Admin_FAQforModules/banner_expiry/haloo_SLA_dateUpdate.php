...
// URL to call
$url = 'https://crm.haloocom.in/haloocomCRM/stop_script_date.php?id=TBBangl20240501';
...
if ($newresponse[0] === "True"){
   ...
   //$user_group = "ADMIN";
	...
	$stmt_exdate = "INSERT INTO vicidial_expiry_date (start_date,end_date,payment_status)VALUES('$install_date','$stop_date','$payment_status')";     
