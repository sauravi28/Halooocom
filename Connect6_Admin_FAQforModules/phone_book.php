      ...
      if (!empty($_FILES['uploadfile']['name']) && in_array($_FILES['uploadfile']['type'], $csvMimes)) {
        ...
        if (is_uploaded_file($_FILES['uploadfile']['tmp_name'])) {
          ...
          while (($line = fgetcsv($csvFile)) !== FALSE) {
            ...
            $stmt_insert = "INSERT INTO phone_book(created_date,name,number,email,campaign) values('$date','$name','$number','$email','$campaign')";
...
if ($_POST['deleteVoiceblasting'] == 'delete_Voiceblast') {
  ...
  $stmt_delete = "delete from phone_book where id='$deleteList'";
...
<li>
        ...
        <div class="container-fluid">
          <div class="card-footer">
            <?php if ($loggedInUserLevel == "SuperAdmin") { ?>
              <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Upload Phone Numbers</button>&nbsp;&nbsp;
            <?php } ?>
          ...
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">UPLOADED PHONE BOOK</h3>
                ...
                <div class="col-md-12">
                  <div class="card-body p-0">
                    <table class="table table-striped projects table-bordered" id="table_camp">
                      ...
                      <tbody>
                        <?php
                        $stmt_select = "SELECT id, created_date, name, number, email, campaign from phone_book";
                        $rslt_rs = mysqli_query($conn, $stmt_select);
                          ...
                          <tr>
                            ...
                            <?php if ($loggedInUserLevel == "SuperAdmin") { ?>
                              <td class="project-actions text-right">
                                ...
                                <span class="btn btn-danger" onclick="document.getElementById('myModal_delete').style.display='block'; voiceBlastDeleteFun('<?php echo $row["id"]; ?>','<?php echo $row["name"]; ?>')">
            ...
            <div class="modal-dialog" style="overflow: scroll; height:400px;">
              <div class="modal-content scrollit">
                ...
                <div class="modal-header">
                  <h4 class="modal-title">Upload Phone Book</h4>
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group" id="campaign_display">
					   ...
					   <div class="form-group">
                        <label for="CampaignName">Upload Phone Numbers ( csv format )<span style="color:red;">*</span></label>
          ...
          <div class="modal fade" id="myModal_delete" style="opacity: 3;top : 104px !important">
            <div class="modal-dialog">
              <div class="modal-content" style="top:40px;">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                  <h4 class="modal-title">Delete Phone Book</h4>
  ...
  var myWindow = window.open("help/phonebookFAQ.html", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=50,width=400,height=400");
}
