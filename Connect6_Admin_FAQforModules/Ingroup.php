...
if($loggedInuserName == '' && $loggedInPassword == '' ){
	header('Location:/haloocomConnect5/pages/Agent/connect5Login/index.php');
		...
		if($_POST['addIngroup']){
			...
			$Ingroup_id = $_POST['Ingroup_id'];
			$Ingroup_name = $_POST['Ingroup_name'];
			
		 
		 
		 $stmt_rs="SELECT ingroup_id from ingroups where ingroup_id='$Ingroup_id';";
			...
			$stmt_insert="INSERT INTO ingroups(created_date,ingroup_id,ingroup_name) values('$date','$Ingroup_id','$Ingroup_name')";
					$rslt_insert= mysqli_query($conn,$stmt_insert);
					
	                          
							}else{
								echo "<script>alert('Ingroups Id already exist.');</script>";
							}
	...
	if($_POST['editIngroup'] == 'edit_Ingroup'){
			...
			$txt_ingroup_id = $_POST['txt_ingroup_id'];
			$txt_ingroup_name = $_POST['txt_ingroup_name'];
			$txt_id = $_POST['txt_id'];	
			
			
			 $stmt_update = "update ingroups set ingroup_id='$txt_ingroup_id',ingroup_name='$txt_ingroup_name' where id='$txt_id'";
			$rslt_update= mysqli_query($conn,$stmt_update);		
	}
	
	if($_POST['deleteIngroup'] == 'delete_Ingroup'){	
			$deleteIngroupID = $_POST['deleteIngroupID'];		
		$stmt_delete = "delete from ingroups where id='$deleteIngroupID'";
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #1A2B6D; color:white;">
    ...
    <a href="../../index.php" class="brand-link" style="background-color: #1A2B6D; color:white;">
      ...
      <span class="brand-text font-weight-light" style="color:#1A2B6D;">Ingroup</span>
    </a>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ingroups</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
		  <div class="card-footer">
		    <?php if($loggedInUserLevel =="SuperAdmin"){?>
			    <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD INGROUP</button>
			<?php } ?>
		   </div>
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">INGROUP LISTINGS</h3>
             ...
             <table class="table table-striped projects table-bordered" id="table_camp">
			  ...
			  ?>
                  <tr>
                      ...
                      <td>
                          <a>
                             <?php echo $row["ingroup_id"]; ?>
                          </a>
                      </td>
                      <td>
                         <?php echo $row["ingroup_name"]; ?>
                      </td>
                      ...
                      <td class="project-actions text-right">
						 <span class="btn btn-info btn-sm"  onclick = "document.getElementById('myModal_edit').style.display='block'; ingroupEditFun('<?php echo $row["id"]; ?>')">
					         ...
					         <span class="btn btn-danger btn-sm"  onclick = "document.getElementById('myModal_delete').style.display='block'; ingroupDeleteFun('<?php echo $row["id"]; ?>','<?php echo $row["ingroup_id"]; ?>','<?php echo $row["ingroup_name"]; ?>')">
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="top:40px;">
        ...
        <div class="modal-header">
          <h4 class="modal-title">EDIT INGROUP</h4>
			...
			<form action = "<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                <div class="card-body">
                   <div class="form-group">
                    <label for="Ingroup">Ingroup Id<span style="color:red;">*</span></label>
                    <input type="text" class="form-control" pattern="^[a-zA-Z0-9\s]*$" title="Please enter only numbers and characters" id="txt_ingroup_id" name="txt_ingroup_id" readonly>
                  </div>
                  <div class="form-group">
                    <label for="IngroupName">Ingroup Name<span style="color:red;">*</span></label>
                    <input type="text" class="form-control" pattern="^[a-zA-Z0-9\s]*$" title="Please enter only numbers and characters" id="txt_ingroup_name" name="txt_ingroup_name" required>
                  </div>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">ADD A NEW INGROUP</h4>
		  <button onclick="myFunctionForFAQ();" title="Add New Ingroup FAQ" style="border: none;background-color: white;"><i class="fa fa-question-circle" aria-hidden="true" style="font-size:20px;margin-top:7px;"></i></button>
        ...
        <div class="modal-body">
			<form action = "<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="Ingroup">Ingroup Id<span style="color:red;">*</span></label>
                    <input type="text" class="form-control" pattern="^[a-zA-Z0-9\s]*$" title="Please enter only numbers and characters" id="Ingroup_id" name="Ingroup_id" placeholder="Enter Ingroup ID" required>
                  </div>
                  <div class="form-group">
                    <label for="IngroupName">Ingroup Name<span style="color:red;">*</span></label>
                    <input type="text" class="form-control" pattern="^[a-zA-Z0-9\s]*$" title="Please enter only numbers and characters" id="Ingroup_name" name="Ingroup_name" placeholder="Enter Ingroup Name" required>
                  </div>
...
function myFunctionForFAQ() {
  var myWindow = window.open("help/ingroupFAQ.html", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=50,width=400,height=400");
}
  ...
  function ingroupEditFun(val)
	{
		...
		//alert(res);
			document.getElementById('txt_ingroup_id').value=res[0];
			document.getElementById('txt_ingroup_name').value=res[1];
			document.getElementById('txt_id').value=res[2];
			
		    }
        }; 
		xhttp.open("GET", "/haloocomConnect5/pages/Agent_mongodb/ajax/get_ingroupedit_data.php?id="+val, true);
		xhttp.send();	  
		// Get the modal
