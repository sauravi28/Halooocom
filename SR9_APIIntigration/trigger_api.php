					...
					while($row1 = mysqli_fetch_array($resultstmt)){
						...
						if($cnt > 0 )
						{
							...
							curl_setopt_array($curl, array(
							  CURLOPT_URL => 'https://qa115-admin.rebase.in/bot_api/getApiAccessToken',
							...
							$url = 'https://qa115-admin.rebase.in/bot_api/getApiAccessTokenFromRefreshToken';
							...
							curl_setopt_array($curl, array(
							  CURLOPT_URL => 'https://qa115-admin.rebase.in/bot_api/getApiCallDataFromBotApi',
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => '',
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
								...
								$voiceFiles = $recording_filename;
											...
											if($row_voiceFile[0] > 0){
												...
												//echo "Dublicate files checking.. for avoiding"; 
														...
														$fh = fopen('/srv/www/htdocs/Haloo_Voicelogs/voicefiles/'.$voiceFilesPath.'/'.$dataFile, 'r');
													if ($fh){
															curl_setopt($ch, CURLOPT_USERPWD, $sftpUsername . ':' . $sftpPassword);
															curl_setopt($ch, CURLOPT_UPLOAD, true);
															curl_setopt($ch, CURLOPT_PROTOCOLS, CURLPROTO_SFTP);
															curl_setopt($ch, CURLOPT_INFILE, $fh);
															curl_setopt($ch, CURLOPT_INFILESIZE, filesize('/srv/www/htdocs/Haloo_Voicelogs/voicefiles/'.$voiceFilesPath.'/'.$dataFile));
