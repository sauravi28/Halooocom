  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">AGENT TELEGRAM CHAT REPORT</h3>
            <br><br>
			  <?php
            ...
            <div class="card-body p-0">
             ...
             <tbody>
			  <?php 	
							...
							$stmt_login="SELECT `date`,`sent_id`,`incoming_id`,`msg` FROM `messages` where date >='$start_date 00:00:00' and date <='$end_date 23:59:59'";
                            //echo $stmt_login;
						   //die;
							  ...
							  while($row = mysqli_fetch_assoc($rslt_login)) {
								  ...
								  $senderName = $row["sent_id"];
								  $message_to = $row["incoming_id"];
								  $message = $row["msg"];
								  
								      $stmt1="SELECT `namez` FROM `teleusers` WHERE chatid='$senderName'";
    ...
    $('#table_camp').DataTable( {
		...
		"dom": "1Bfrtip",
		 ...
		 'pageLength',
            ...
            {
                extend: 'csv',
				title:'Agent_telegram_Report_'+date
