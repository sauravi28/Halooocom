  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">AGENT CHAT REPORT</h3>
            <br><br>
			  <?php
            ...
            <div class="card-body p-0">
             ...
             <tbody>
			  <?php 	
							...
							$stmt_login="SELECT `created_date`,`senderName`,`message`,`messageReceiver`,`user`,campaign FROM `internalChat` where user='$user' and created_date >='$start_date 00:00:00' and created_date <='$end_date 23:59:59'";
                            //echo $stmt_login;
						   //die;
							  ...
							  while($row = mysqli_fetch_assoc($rslt_login)) {
								...
								?>
											<tr>
											  ...
											  <td class="col-xs-4" style="text-align: center;"><?php echo $senderName; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $messageReceiver; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $message; ?></td>
