			...
			echo "Voicefile File".$filename1."is not there in the DB";
				 ...
				 // Dispo//
						...
						if($row_fileid[0] !=''){
							...
							$sel_status = "select count(*),status From vicidial_log where uniqueid = '$row_fileid[0]'";
							//echo $sel_status;
							//echo "<br>";
							...
							//Incoming//
							$sel_status_in = "select count(*),status From vicidial_closer_log  where closecallid = '$row_fileid[0]'";
							//echo $sel_status_in;
							//echo "<br>";
           	    ...
           	    $sql = "insert into voicefiles(date,time,source,destination,duration,filename,campaign,disposition)values('$date_cal','$time','$source','$destination','$duration','$filename1','$campaign','$Disposition')";
