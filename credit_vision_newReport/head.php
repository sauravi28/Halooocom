       ...
       <li class="treeview"><a href="#"><i class="fa fa-files-o"></i> <span><?php echo  _QXZ("Lists");  ?></span><i class="fa fa-angle-left pull-right"></i>
        ...
        <?php
         ...
         <ul class="treeview-menu">
          ...
          <li>
           <?php } if($PHP_AUTH_USER =="6666"){?><a href="admin_search_lead.php"><i class="fa fa-circle-o"></i><?php echo  _QXZ("Search For A Lead");  ?></a></li>
	...
	if (strlen($admin_hh) > 1) 
		...
		?>
           ...
           <ul class="treeview-menu">
			...
			if ($SSoutbound_autodial_active > 0)
             ...
             <?php 
              ...
              <li>
               <?php } if($PHP_AUTH_USER=='6666'){ ?><a href="group_hourly_stats.php"><i class="fa fa-circle-o"></i><?php echo _QXZ("Group Hourly Report"); ?></a></li>
              <li><a href="user_group_bulk_change.php"><i class="fa fa-circle-o"></i><?php echo _QXZ("Bulk Group Change"); ?></a></li>
			   <?php } ?>
              <li><a href="<?php echo $ADMIN ?>?ADD=10000"><i class="fa fa-circle-o"></i><?php echo _QXZ("Show Remote Agents"); ?></a></li>
              <li>
              ...
              <li>
               <?php } if($PHP_AUTH_USER=='6666'){?><a href="<?php echo $ADMIN ?>?ADD=12000"><i class="fa fa-circle-o"></i><?php echo _QXZ("Show Extension Groups"); ?></a></li>
              <li>
		  ...
		  <!-- EXPIRY DATE NAVIGATION -->
           ...
           <?php if($user_name == '6666') { ?> <li><a href="<?php echo $ADMIN ?>?ADD=2B"> <i class="fa fa-calendar"></i> <span><?php echo _QXZ("Add Expiry Date");?></span> </a> </li><?php } ?>
