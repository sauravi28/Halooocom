...
# optional variables:
#  - $format - ('text','debug')
#  - $ACTION - ('regCLOSER','regTERRITORY','manDiaLnextCALL','manDiaLskip','manDiaLonly','manDiaLlookCaLL','manDiaLlogCALL','userLOGoutuserLOGout','updateDISPO','updateLEAD','VDADpause','VDADready','VDADcheckINCOMING','UpdatEFavoritEs','CalLBacKLisT','CalLBacKCounT','PauseCodeSubmit','LogiNCamPaigns','alt_phone_change','AlertControl','AGENTSview','CALLSINQUEUEview','CALLSINQUEUEgrab','DiaLableLeaDsCounT','UpdateFields','CALLLOGview','LEADINFOview','customer_3way_hangup_process')
...
//Extra Fields
if (isset($_GET["field1"]))					{$field1=$_GET["field1"];}
	elseif (isset($_POST["field1"]))			{$field1=$_POST["field1"];}
if (isset($_GET["field2"]))					{$field2=$_GET["field2"];}
	elseif (isset($_POST["field2"]))			{$field2=$_POST["field2"];}
if (isset($_GET["field3"]))					{$field3=$_GET["field3"];}
	elseif (isset($_POST["field3"]))			{$field3=$_POST["field3"];}
if (isset($_GET["field4"]))					{$field4=$_GET["field4"];}
	elseif (isset($_POST["field4"]))			{$field4=$_POST["field4"];}
if (isset($_GET["field5"]))					{$field5=$_GET["field5"];}
	elseif (isset($_POST["field5"]))			{$field5=$_POST["field5"];}
if (isset($_GET["field6"]))					{$field6=$_GET["field6"];}
	elseif (isset($_POST["field6"]))			{$field6=$_POST["field6"];}
if (isset($_GET["field7"]))					{$field7=$_GET["field7"];}
	elseif (isset($_POST["field7"]))			{$field7=$_POST["field7"];}
if (isset($_GET["field8"]))					{$field8=$_GET["field8"];}
	elseif (isset($_POST["field8"]))			{$field8=$_POST["field8"];}
if (isset($_GET["field9"]))					{$field9=$_GET["field9"];}
	elseif (isset($_POST["field9"]))			{$field9=$_POST["field9"];}
if (isset($_GET["field10"]))					{$field10=$_GET["field10"];}
	elseif (isset($_POST["field10"]))			{$field10=$_POST["field10"];}	
	
	
if (isset($_GET["field11"]))					{$field11=$_GET["field11"];}
	elseif (isset($_POST["field11"]))			{$field11=$_POST["field11"];}
if (isset($_GET["field12"]))					{$field12=$_GET["field12"];}
	elseif (isset($_POST["field12"]))			{$field12=$_POST["field12"];}
if (isset($_GET["field13"]))					{$field13=$_GET["field13"];}
	elseif (isset($_POST["field13"]))			{$field13=$_POST["field13"];}
if (isset($_GET["field14"]))					{$field14=$_GET["field14"];}
	elseif (isset($_POST["field14"]))			{$field14=$_POST["field14"];}
if (isset($_GET["field15"]))					{$field15=$_GET["field15"];}
	elseif (isset($_POST["field15"]))			{$field15=$_POST["field15"];}
if (isset($_GET["field16"]))					{$field16=$_GET["field16"];}
	elseif (isset($_POST["field16"]))			{$field16=$_POST["field16"];}
if (isset($_GET["field17"]))					{$field17=$_GET["field17"];}
	elseif (isset($_POST["field7"]))			{$field17=$_POST["field17"];}
if (isset($_GET["field18"]))					{$field18=$_GET["field18"];}
	elseif (isset($_POST["field8"]))			{$field18=$_POST["field18"];}
if (isset($_GET["field19"]))					{$field19=$_GET["field19"];}
	elseif (isset($_POST["field19"]))			{$field19=$_POST["field19"];}
if (isset($_GET["field20"]))					{$field20=$_GET["field20"];}
	elseif (isset($_POST["field20"]))			{$field20=$_POST["field20"];}
	
	
if (isset($_GET["field21"]))					{$field21=$_GET["field21"];}
	elseif (isset($_POST["field21"]))			{$field21=$_POST["field21"];}
if (isset($_GET["field22"]))					{$field22=$_GET["field22"];}
	elseif (isset($_POST["field22"]))			{$field22=$_POST["field22"];}
if (isset($_GET["field23"]))					{$field23=$_GET["field23"];}
	elseif (isset($_POST["field23"]))			{$field23=$_POST["field23"];}
if (isset($_GET["field24"]))					{$field24=$_GET["field24"];}
	elseif (isset($_POST["field24"]))			{$field24=$_POST["field24"];}
if (isset($_GET["field25"]))					{$field25=$_GET["field25"];}
	elseif (isset($_POST["field25"]))			{$field25=$_POST["field25"];}
if (isset($_GET["field26"]))					{$field26=$_GET["field26"];}
	elseif (isset($_POST["field26"]))			{$field26=$_POST["field26"];}
if (isset($_GET["field27"]))					{$field27=$_GET["field27"];}
	elseif (isset($_POST["field27"]))			{$field27=$_POST["field27"];}
if (isset($_GET["field28"]))					{$field28=$_GET["field28"];}
	elseif (isset($_POST["field28"]))			{$field28=$_POST["field28"];}
if (isset($_GET["field29"]))					{$field29=$_GET["field29"];}
	elseif (isset($_POST["field29"]))			{$field29=$_POST["field29"];}
if (isset($_GET["field30"]))					{$field30=$_GET["field30"];}
	elseif (isset($_POST["field30"]))			{$field30=$_POST["field30"];}
	
	
if (isset($_GET["field31"]))					{$field31=$_GET["field31"];}
	elseif (isset($_POST["field31"]))			{$field31=$_POST["field31"];}
if (isset($_GET["field32"]))					{$field32=$_GET["field32"];}
	elseif (isset($_POST["field32"]))			{$field32=$_POST["field32"];}
if (isset($_GET["field33"]))					{$field33=$_GET["field33"];}
	elseif (isset($_POST["field33"]))			{$field33=$_POST["field33"];}
if (isset($_GET["field34"]))					{$field34=$_GET["field34"];}
	elseif (isset($_POST["field34"]))			{$field34=$_POST["field34"];}
if (isset($_GET["field35"]))					{$field35=$_GET["field35"];}
	elseif (isset($_POST["field35"]))			{$field35=$_POST["field35"];}
if (isset($_GET["field36"]))					{$field36=$_GET["field36"];}
	elseif (isset($_POST["field36"]))			{$field36=$_POST["field36"];}
if (isset($_GET["field37"]))					{$field37=$_GET["field37"];}
	elseif (isset($_POST["field37"]))			{$field37=$_POST["field37"];}
if (isset($_GET["field38"]))					{$field38=$_GET["field38"];}
	elseif (isset($_POST["field38"]))			{$field38=$_POST["field38"];}
if (isset($_GET["field39"]))					{$field39=$_GET["field39"];}
	elseif (isset($_POST["field39"]))			{$field39=$_POST["field39"];}
if (isset($_GET["field40"]))					{$field40=$_GET["field40"];}
	elseif (isset($_POST["field40"]))			{$field40=$_POST["field40"];}			
	
	if (isset($_GET["manualNumber"]))					{$manualNumber=$_GET["manualNumber"];}
	elseif (isset($_POST["manualNumber"]))			{$manualNumber=$_POST["manualNumber"];}	
...
if ($ACTION == 'UpdateFields')
	...
	if ($vla_records > 0) 
		...
		$stmt="SELECT vendor_lead_code,source_id,gmt_offset_now,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,rank,owner,entry_date,field1,field2,field3,field4,field5,field6,field7,field8 ,field9 ,field10,field11,field12,field13,field14,field15,field16,field17,field18 ,field19 ,field20,field21,field22,field23,field24,field25,field26,field27,field28 ,field29 ,field30,field31,field32,field33,field34,field35,field36,field37,field38 ,field39 ,field40  FROM vicidial_list where lead_id='$lead_id' LIMIT 1;";
		$rslt=mysql_to_mysqli($stmt, $link);
...
if ($ACTION == 'manDiaLnextCaLL')
	...
	if ( (strlen($conf_exten)<1) || (strlen($campaign)<1)  || (strlen($ext_context)<1) )
		...
		if ($affected_rows > 0)
            ...
            ######## alternate number testing
			if($manualNumber !='')
			{
		    $sel_number = "select  phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18 ,field19 ,field20,field21,field22,field23,field24,field25,field26,field27,field28 ,field29 ,field30,field31,field32,field33,field34,field35,field36,field37,field38 ,field39 ,field40 from vicidial_list where field7 = '$manualNumber' OR field8 = '$manualNumber' OR field9 = '$manualNumber' OR field10 = '$manualNumber' OR field11 = '$manualNumber' OR field12 = '$manualNumber' OR field13 = '$manualNumber' OR field14 = '$manualNumber' OR field15 = '$manualNumber' OR field16 = '$manualNumber' OR field17 = '$manualNumber' OR field18 = '$manualNumber' OR field19 = '$manualNumber' OR field20 = '$manualNumber' OR field21 = '$manualNumber'";
            $res_number = mysqli_query($link,$sel_number);
            $row_number = mysqli_fetch_array($res_number);
            $row_num    = mysqli_num_rows($res_number);
           
        
            if($row_num > 0)
            {
              $sel_update = "update vicidial_list set title = '$row_number[1]',first_name='$row_number[2]',middle_initial='$row_number[3]',last_name='$row_number[4]',address1='$row_number[5]',address2='$row_number[6]',address3='$row_number[7]',city='$row_number[8]',state='$row_number[9]',province='$row_number[10]',postal_code='$row_number[11]',country_code='$row_number[12]',gender='$row_number[13]',date_of_birth='$row_number[14]',alt_phone='$row_number[15]',email='$row_number[16]',security_phrase='$row_number[17]',comments='$row_number[18]',field1='$row_number[19]',field2='$row_number[20]',field3='$row_number[21]',field4='$row_number[22]',field5='$row_number[23]',field6='$row_number[24]',field7='$row_number[25]',field8='$row_number[26]',field9='$row_number[27]',field10='$row_number[28]',field11='$row_number[29]',field12='$row_number[30]',field13='$row_number[31]',field14='$row_number[32]',field15='$row_number[33]',field16='$row_number[34]',field17='$row_number[35]',field18='$row_number[36]',field19='$row_number[37]',field20='$row_number[38]',field21='$row_number[39]',field22='$row_number[40]',field23='$row_number[41]',field24='$row_number[42]',field25='$row_number[43]',field26='$row_number[44]',field27='$row_number[45]',field28='$row_number[46]' ,field29='$row_number[47]' ,field30='$row_number[48]',field31='$row_number[49]',field32='$row_number[50]',field33='$row_number[51]',field34='$row_number[52]',field35='$row_number[53]',field36='$row_number[54]',field37='$row_number[55]',field38='$row_number[56]' ,field39='$row_number[57]' ,field40='$row_number[58]'  where lead_id ='$lead_id'";
              $res_update = mysqli_query($link,$sel_update);
			}
			}
			

			##### grab the data from vicidial_list for the lead_id
			$stmt="SELECT lead_id,entry_date,modify_date,status,user,vendor_lead_code,source_id,list_id,gmt_offset_now,called_since_last_reset,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,called_count,last_local_call_time,rank,owner,entry_list_id,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18 ,field19 ,field20,field21,field22,field23,field24,field25,field26,field27,field28 ,field29 ,field30,field31,field32,field33,field34,field35,field36,field37,field38 ,field39 ,field40   FROM vicidial_list where lead_id='$lead_id' LIMIT 1;";
		...
		if ($queue_leadID_ct > 0)
			...
			#	$lead_id		= trim("$row[0]");
				...
				$phone_number	= trim("$row[11]");
					...
					if($phone_number != '')
			{
			$sel_number = "select  phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18 ,field19 ,field20,field21,field22,field23,field24,field25,field26,field27,field28 ,field29 ,field30,field31,field32,field33,field34,field35,field36,field37,field38 ,field39 ,field40,lead_id from vicidial_list where phone_number = '$phone_number' OR field24 = '$phone_number' OR field25 = '$phone_number' OR field26 = '$phone_number' OR field27 = '$phone_number' OR field28 = '$phone_number' OR field29 = '$phone_number' OR field30 = '$phone_number' OR field31 = '$phone_number' OR field32 = '$phone_number' OR field33 = '$phone_number'";
            $res_number = mysqli_query($link,$sel_number);
            $row_number = mysqli_fetch_array($res_number);
            $row_num    = mysqli_num_rows($res_number);
...
if ($ACTION == 'updateDISPO')
	...
	if ( ( (strlen($phone_number)<1) and (strlen($email)<1) ) or (strlen($lead_id)<1) )
		...
		if ($DO_NOT_UPDATE < 1)
			...
			$stmt="UPDATE vicidial_list set vendor_lead_code='" . mysqli_real_escape_string($link, $vendor_lead_code) . "', title='" . mysqli_real_escape_string($link, $title) . "', first_name='" . mysqli_real_escape_string($link, $first_name) . "', middle_initial='" . mysqli_real_escape_string($link, $middle_initial) . "', last_name='" . mysqli_real_escape_string($link, $last_name) . "', address1='" . mysqli_real_escape_string($link, $address1) . "', address2='" . mysqli_real_escape_string($link, $address2) . "', address3='" . mysqli_real_escape_string($link, $address3) . "', city='" . mysqli_real_escape_string($link, $city) . "', state='" . mysqli_real_escape_string($link, $state) . "', province='" . mysqli_real_escape_string($link, $province) . "', postal_code='" . mysqli_real_escape_string($link, $postal_code) . "', country_code='" . mysqli_real_escape_string($link, $country_code) . "', gender='" . mysqli_real_escape_string($link, $gender) . "', date_of_birth='" . mysqli_real_escape_string($link, $date_of_birth) . "', alt_phone='" . mysqli_real_escape_string($link, $alt_phone) . "', email='" . mysqli_real_escape_string($link, $email) . "', security_phrase='" . mysqli_real_escape_string($link, $security_phrase) . "', field1='" . mysqli_real_escape_string($link, $field1) . "',field2='" . mysqli_real_escape_string($link, $field2) . "',field3='" . mysqli_real_escape_string($link, $field3) . "',field4='" . mysqli_real_escape_string($link, $field4) . "',field5='" . mysqli_real_escape_string($link, $field5) . "',field6='" . mysqli_real_escape_string($link, $field6) . "',field7='" . mysqli_real_escape_string($link, $field7) . "',field8='" . mysqli_real_escape_string($link, $field8) . "',field9='" . mysqli_real_escape_string($link, $field9) . "',field10='" . mysqli_real_escape_string($link, $field10) . "',field11='" . mysqli_real_escape_string($link, $field11) . "',field12='" . mysqli_real_escape_string($link, $field12) . "',field13='" . mysqli_real_escape_string($link, $field13) . "',field14='" . mysqli_real_escape_string($link, $field14) . "',field15='" . mysqli_real_escape_string($link, $field15) . "',field16='" . mysqli_real_escape_string($link, $field16) . "',field17='" . mysqli_real_escape_string($link, $field17) . "',field18='" . mysqli_real_escape_string($link, $field18) . "',field19='" . mysqli_real_escape_string($link, $field19) . "',field20='" . mysqli_real_escape_string($link, $field20) . "'

,field21='" . mysqli_real_escape_string($link, $field21) . "',field22='" . mysqli_real_escape_string($link, $field22) . "',field23='" . mysqli_real_escape_string($link, $comments) . "',field24='" . mysqli_real_escape_string($link, $field24) . "',field25='" . mysqli_real_escape_string($link, $field25) . "',field26='" . mysqli_real_escape_string($link, $field26) . "',field27='" . mysqli_real_escape_string($link, $field27) . "',field28='" . mysqli_real_escape_string($link, $field28) . "',field29='" . mysqli_real_escape_string($link, $field29) . "',field30='" . mysqli_real_escape_string($link, $field30) . "'

,field31='" . mysqli_real_escape_string($link, $field31) . "',field32='" . mysqli_real_escape_string($link, $field32) . "',field33='" . mysqli_real_escape_string($link, $field33) . "',field34='" . mysqli_real_escape_string($link, $field34) . "',field35='" . mysqli_real_escape_string($link, $field35) . "',field36='" . mysqli_real_escape_string($link, $field36) . "',field37='" . mysqli_real_escape_string($link, $field37) . "',field38='" . mysqli_real_escape_string($link, $field38) . "',field39='" . mysqli_real_escape_string($link, $field39) . "',field40='" . mysqli_real_escape_string($link, $field40) . "', comments='" . mysqli_real_escape_string($link, $comments) . "' $phoneSQL where lead_id='$lead_id';";
				if ($format=='debug') {echo "\n<!-- $stmt -->";}
			$rslt=mysql_to_mysqli($stmt, $link);
	...
	#	fclose($fp);
		...
		if ($row[0] > 0)
			{
			$call_type='IN';
			$stmt = "UPDATE vicidial_closer_log set status='$log_dispo_choice',field1='$field1',field2='$field2',field3='$field3',field4='$field4',field5='$field5',field6='$field6',field7='$field7',field8='$field8',field9='$field9',field10='$field10',field11='$field11',field12='$field12',field13='$field13',field14='$field14',field15='$field15',field16='$field16',field17='$field17',field18='$field18',field19='$field19',field20='$field20'
,field11='$field11',field21='$field21',field23='$field23',field24='$field24',field25='$field25',field26='$field26',field27='$field27',field28='$field28',field29='$field29',field30='$field30'
,field31='$field31',field32='$field32',field33='$field33',field34='$comments',field35='$field35',field36='$field36',field37='$field37',field38='$field38',field39='$field39',field40='$field40' $term_reasonSQL where lead_id='$lead_id' and user='$user' order by closecallid desc limit 1;";
			if ($DB) {echo "$stmt\n";}
			$rslt=mysql_to_mysqli($stmt, $link);
			...
			if ( ($auto_dial_level < 1) or (preg_match('/^M/',$MDnextCID)) )
				{
					...
					//#######################whatsup integration ###############################
/*$arr = array(918095623319, 919738031110,919886620544,919606849012,919066525946,916361796923,919066774457);
foreach ($arr as $value) {
   $data = [
    'phone' => $value, // Receivers phone
    'body' => 'Haloocom Whatsapp Integration', // Message
];

$json = json_encode($data); // Encode data to JSON
// URL for request POST /message
$url = 'https://eu15.chat-api.com/instance25956/message?token=bw5p10gu5dy19o8h';
// Make a POST request
...
echo $result;
				...
				if ($row[0] > 0)
					{
					$stmt="UPDATE vicidial_log set status='$log_dispo_choice',user='$user',field1='$field1',field2='$field2',field3='$field3',field4='$field4',field5='$field5',field6='$field6',field7='$field7',field8='$field8',field9='$field9',field10='$field10',field11='$field11',field12='$field12',field13='$field13',field14='$field14',field15='$field15',field16='$field16',field17='$field17',field18='$field18',field19='$field19',field20='$field20'
,field11='$field11',field21='$field21',field23='$field23',field24='$field24',field25='$field25',field26='$field26',field27='$field27',field28='$field28',field29='$field29',field30='$field30'
,field31='$field31',field32='$field32',field33='$field33',field34='$comments',field35='$field35',field36='$field36',field37='$field37',field38='$field38',field39='$field39',field40='$field40' $term_reasonSQL where lead_id='$lead_id' and call_date > \"$four_hours_ago\" and called_count='$called_count' order by uniqueid desc limit 1;";
						if ($format=='debug') {echo "\n<!-- $stmt -->";}
					$rslt=mysql_to_mysqli($stmt, $link);
    ...
    if(($log_dispo_choice == 'RPCCPU') or  ($log_dispo_choice == 'pTp') or ($log_dispo_choice == 'CCB')or ($log_dispo_choice == 'OFS') or ($log_dispo_choice == 'OP') or ($log_dispo_choice == 'PL') or ($log_dispo_choice == 'RPCDRT'))
    {
//$CallBackDatETimE = "0000-00-00 00:00:00";
$stmt="INSERT INTO vicidial_callbacks (lead_id,list_id,campaign_id,status,entry_time,callback_time,user,recipient,comments,user_group,lead_status) values('$lead_id','$list_id','$campaign','INACTIVE','$NOW_TIME','$CallBackDatETimE','$user','$recipient','$comments','$user_group','$CallBackLeadStatus');";
                if ($DB) {echo "$stmt\n";}
                $rslt=mysql_to_mysqli($stmt, $link);
    ...
    if($log_dispo_choice == 'RPCCPU' || $log_dispo_choice == 'pTp' || $log_dispo_choice == 'CALLBK' ||$log_dispo_choice == 'CCB' ||$log_dispo_choice == 'OFS' ||$log_dispo_choice == 'OP' ||$log_dispo_choice == 'PL' ||$log_dispo_choice == 'RPCDRT')
    {
        $stmt="UPDATE vicidial_list set status='$log_dispo_choice', user='$user' $commentsSQL where lead_id='$lead_id';";
	    if ($format=='debug') {echo "\n<!-- $stmt -->";}
		$rslt=mysql_to_mysqli($stmt, $link);
    }
	...
	while ($dispo_call_url_count > $j)
       ...
       /* ####################    sms code to send data start############################################*/
if($dispo_choice == 'APPT')
{		
$handle = curl_init();
$msg = " $user, Set an appointment for mr.$first_name,";
$msg = urlencode($msg);
$url = "https://www.smsgatewayhub.com/api/mt/SendSMS?APIKey=7dd36abc-7853-4c20-92a6-f70bb06b873b&senderid=SSTAYS&channel=2&DCS=0&flashsms=0&number=$phone&text=$msg&route=21";
...
elseif($dispo_choice == 'SALE')
{
        $handle = curl_init();
$msg = "Hi $first_name,$user made Sale.";
$msg = urlencode($msg);
$url = "https://www.smsgatewayhub.com/api/mt/SendSMS?APIKey=7dd36abc-7853-4c20-92a6-f70bb06b873b&senderid=SSTAYS&channel=2&DCS=0&flashsms=0&number=$phone&text=$msg&route=21";
		...
		if ($DO_NOT_UPDATE < 1)
			...
			if ($DO_NOT_UPDATEphone < 1)
				{$phoneSQL = ",phone_number='$phone_number'";}
			      ...
			      $sel_number = "select  phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18 ,field19 ,field20,field21,field22,field23,field24,field25,field26,field27,field28 ,field29 ,field30,field31,field32,field33,field34,field35,field36,field37,field38 ,field39 ,field40 from vicidial_list where field24 = '$phone_number' OR field25 = '$phone_number' OR field26 = '$phone_number' OR field27 = '$phone_number' OR field28 = '$phone_number' OR field29 = '$phone_number' OR field30 = '$phone_number' OR field31 = '$phone_number' OR field32 = '$phone_number' OR field33 = '$phone_number'";
            $res_number = mysqli_query($link,$sel_number);
            $row_number = mysqli_fetch_array($res_number);
            $row_num    = mysqli_num_rows($res_number);
...
,field21='" . mysqli_real_escape_string($link, $field21) . "',field22='" . mysqli_real_escape_string($link, $field22) . "',field23='" . mysqli_real_escape_string($link, $field23) . "',field24='" . mysqli_real_escape_string($link, $field24) . "',field25='" . mysqli_real_escape_string($link, $field25) . "',field26='" . mysqli_real_escape_string($link, $field26) . "',field27='" . mysqli_real_escape_string($link, $field27) . "',field28='" . mysqli_real_escape_string($link, $field28) . "',field29='" . mysqli_real_escape_string($link, $field29) . "',field30='" . mysqli_real_escape_string($link, $field30) . "'
...
if ($ACTION == 'AGENTSview')
	...
	echo "</TABLE><BR>\n";
	echo "<font style=\"font-size:9px;font-family:sans-serif;\"><font style=\"background-color:#ADD8E6;\"> &nbsp; &nbsp;</font>-"._QXZ("READY")." &nbsp; <font style=\"background-color:#D8BFD8;\">&nbsp; &nbsp;</font>-"._QXZ("INCALL")." &nbsp; <font style=\"background-color:#F0E68C;\"> &nbsp; &nbsp;</font>-"._QXZ("PAUSED")." &nbsp;\n";
	if (preg_match("/NOT-LOGGED-IN-AGENTS/",$agent_status_viewable_groups))
...
if ($ACTION == 'CALLSINQUEUEview')
	...
	if (preg_match('/NONE/i',$view_calls_in_queue))
		...
		echo "<TR>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp;&nbsp; </font></TD>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp; "._QXZ("PHONE")." &nbsp; </font></TD>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp; "._QXZ("FULL NAME")." &nbsp; </font></TD>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp; "._QXZ("WAIT")." &nbsp; </font></TD>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp; "._QXZ("AGENT")." &nbsp; </font> </TD>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp;&nbsp; </font></TD>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp; "._QXZ("CALL GROUP")." &nbsp; </font></TD>";
		echo "<TD align=\"center\"><font style=\"font-size:15px;font-family:sans-serif;color:black;\"><B> &nbsp; "._QXZ("TYPE")." &nbsp; </font></TD>";
		echo "</TR>";
		...
		while ( ($calls_count > $loop_count) and ($view_calls_in_queue > $loop_count) )
			...
			if ( (preg_match('/Y/i',$grab_calls_in_queue)) and ($OQcall_type[$loop_count]=='IN') )
				{
				echo "<TR $Qcolor>";
				echo "<TD align=center> <a href=\"#\" onclick=\"callinqueuegrab('$OQauto_call_id[$loop_count]');return false;\"><font style=\"font-size:14px;font-family:sans-serif;\">"._QXZ("TAKE CALL")."</a> &nbsp; </TD>";
				echo "<TD align=center><font style=\"font-size:14px;font-family:sans-serif;\"> &nbsp; $OQphone_number[$loop_count] &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:14px;font-family:sans-serif;\"> &nbsp; $caller_name &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:14px;font-family:sans-serif;\"> &nbsp; $call_time &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:14px;font-family:sans-serif;\"> &nbsp; $agent - $agent_name &nbsp; </font></TD>";
				echo "<TD align=center bgcolor=\"$group_color\"><font style=\"font-size:14px;font-family:sans-serif;\"> &nbsp; &nbsp; &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:14px;font-family:sans-serif;\"> &nbsp; $OQcampaign_id[$loop_count] - $group_name &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:14px;font-family:sans-serif;\"> &nbsp; $OQcall_type[$loop_count] &nbsp; </font></TD>";
				echo "</TR>";
				}
			else
				{
				...
				echo "<TD align=center><font style=\"font-size:16px;font-family:sans-serif;\"> &nbsp; $OQphone_number[$loop_count] &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:16px;font-family:sans-serif;\"> &nbsp; $caller_name &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:16px;font-family:sans-serif;\"> &nbsp; $call_time &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:16px;font-family:sans-serif;\"> &nbsp; $agent - $agent_name &nbsp; </font></TD>";
				echo "<TD align=center bgcolor=\"$group_color\"><font style=\"font-size:16px;font-family:sans-serif;\"> &nbsp; &nbsp; &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:16px;font-family:sans-serif;\"> &nbsp; $OQcampaign_id[$loop_count] - $group_name &nbsp; </font></TD>";
				echo "<TD align=center><font style=\"font-size:16px;font-family:sans-serif;\"> &nbsp; $OQcall_type[$loop_count] &nbsp; </font></TD>";
				echo "</TR>";
				}
			$loop_count++;
			}
...
if ($ACTION == 'CALLLOGview')
	...
	echo "<CENTER>\n";
	echo "<BR><font style=\"font-size:20px;font-family:sans-serif;color:#1a2b6d;\"><B>";
	echo "<a href=\"#\" style=\"color:#1a2b6d\" onclick=\"VieWCalLLoG('$past_week_date','');return false;\"> << $past_week_date</a> &nbsp; &nbsp; ";
	echo "<a href=\"#\" style=\"color:#1a2b6d\" onclick=\"VieWCalLLoG('$past_day_date','');return false;\"> < $past_day_date</a> &nbsp; &nbsp; ";
	if ($NOW_DATE != $date)
		{echo "<a href=\"#\" style=\"color:#1a2b6d\" onclick=\"VieWCalLLoG('$next_day_date','');return false;\"> $next_day_date > </a> &nbsp; &nbsp; ";}
	echo "<input type=text name=calllogdate id=calllogdate value=\"$date\" size=20 maxlength=10> ";
	echo "<a href=\"#\" style=\"color:#1a2b6d\" onclick=\"VieWCalLLoG('','form');return false;\">"._QXZ("GO")."</a> &nbsp;  &nbsp; &nbsp; ";
//echo "<a href=\"#\" onclick=\"hideDiv('CalLLoGDisplaYBox');return false;\"> "._QXZ("close")." </a>";
	echo "</B></font>\n";
	echo "<BR><BR>\n";
	echo "<TABLE CELLPADDING=0 CELLSPACING=1 BORDER=1>";
	echo "<TR>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; # &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("DATE/TIME")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("LENGTH")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("STATUS")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("PHONE")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("FULL NAME")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("CAMPAIGN")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("IN/OUT")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("ALT")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("HANGUP")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("INFO")." &nbsp; </font></TD>";
	echo "<TD BGCOLOR=\"#1a2b6d\" align=\"center\"><font style=\"font-size:18px;font-family:sans-serif;color:white;\"><B> &nbsp; "._QXZ("DIAL")." &nbsp; </font></TD>";
	echo "</TR>";
	...
	if ($g > 0)
		...
		{echo "<tr bgcolor=white><td colspan=12 align=center>"._QXZ("No calls on this day")."</td></tr>";}
	...
	while ($g > $u) 
		...
		$u++;
		echo "<tr $bgcolor>";
		echo "<td align=center><font size=3 color=white>$u</td>";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\">$ALLcall_date[$i]</td>";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $ALLlength_in_sec[$i]</td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $ALLstatus[$i]</td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $ALLphone_code[$i] $phone_number_display </td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $Allfirst_name[$i] $Alllast_name[$i] </td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $ALLcampaign_id[$i] </td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $ALLin_out[$i] </td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $ALLalt_dial[$i] </td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> $ALLhangup_reason[$i] </td>\n";
		echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> <a href=\"#\" style=\"color:white\" onclick=\"VieWLeaDInfO($ALLlead_id[$i]);return false;\"> "._QXZ("INFO")."</A> </td>\n";
		if ($manual_dial_filter > 0)
			{echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> <a href=\"#\" style=\"color:white\" onclick=\"NeWManuaLDiaLCalL('CALLLOG','$ALLphone_code[$i]','$ALLphone_number[$i]','$ALLlead_id[$i]','','YES');return false;\"> "._QXZ("DIAL")." </A> </td>\n";}
		else
			{echo "<td align=center><font style=\"font-size:16px;font-family:sans-serif;color:white;\"> "._QXZ("DIAL")." </td>\n";}
		echo "</tr>\n";
		}

	echo "</TABLE>";
	echo "<BR>";
	//echo "<a href=\"#\" style=\"background-color:#8bc541;border:none;color: white;padding: 15px 18px; border-radius:12px; text-align: center;text-decoration: none;display: inline-block;font-size:17px;margin: 4px 2px;cursor: pointer;\" onclick=\"CalLLoGVieWClose();return false;\">"._QXZ("Close Call Log")."</a>";
	echo "</CENTER>";
	}
