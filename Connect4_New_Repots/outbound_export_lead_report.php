...
echo "<pre>";
echo print_r($export_rows);
echo "</pre>";
	//exit;

	if ( ($outbound_to_print > 0))
		{
          /*  $date = date('Y-m-d');
            $TXTfilename = "LeadReport-".$date.".csv";
			$fd = fopen ($TXTfilename, "w");*/

		$TXTfilename = "OUTBOUND_EXPORT_LEAD_REPORT_$FILE_TIME.csv";
...
$label_field40 = ($row_data[58]=="---HIDE---")?"":(",$row_data[58]");
			...
			echo "call_date_time,lead_id,list_id,phone_dialed_no,duration,agent_name,user_group,campaign_name,call_status,disconnected_by,manual/auto,caller_remarks$label_title$label_first_name$label_middle_initial$label_last_name$label_address1$label_address2$label_address3$label_city$label_state$label_province$label_postal_code$label_vendor_lead_code$label_phone_number$label_phone_code$label_alt_phone$label_email$label_security_phrase$label_field1$label_field2$label_field3$label_field4$label_field5$label_field6$label_field7$label_field8$label_field9$label_field10$label_field11$label_field12$label_field13$label_field14$label_field15$label_field16$label_field17$label_field18$label_field19$label_field20$label_field21$label_field22$label_field23$label_field24$label_field25$label_field26$label_field27$label_field28$label_field29$label_field30$label_field31$label_field32$label_field33$label_field34$label_field35$label_field36$label_field37$label_field38$label_field39$label_field40,callback_date_time,status_name,recording_filename\r\n";
