...
//$CSV_header.='"'._QXZ("DATE").'","'._QXZ("CENTER").'","'._QXZ("AGENT ID").'","'._QXZ("PROCESS").'","'._QXZ("LOGGED IN DURATION").'","'._QXZ("IDLE TIME").'","'._QXZ("TALK TIME").'","'._QXZ("WRAP UP").'","'._QXZ("RINGING").'","'._QXZ("DAILING").'","'._QXZ("BREAK TIME").'","'._QXZ("AHT").'","'._QXZ("LUNCH TIME").'","'._QXZ("TEA TIME").'","'._QXZ("WASHROOM").'","'._QXZ("TRAINING").'","'._QXZ("FIRST LOGIN").'","'._QXZ("OUTBOUND").'","'._QXZ("CONNECTED").'","'._QXZ("NOT CONNECTED").'","'._QXZ("TOTAL OUT CALLS").'","'._QXZ("DNC").'","'._QXZ("REDAIL").'","'._QXZ("AUTO WRAPUP").'","'._QXZ("WTR").'","'._QXZ("NC").'","'._QXZ("RNR").'","'._QXZ("PAID").'","'._QXZ("PTP").'","'._QXZ("ISSUE").'","'._QXZ("FPTP").'","'._QXZ("EXPRD").'","'._QXZ("CB").'","'._QXZ("LM").'"';

$CSV_header.='"'._QXZ("DATE").'","'._QXZ("CENTER").'","'._QXZ("AGENT ID").'","'._QXZ("PROCESS").'","'._QXZ("LOGGED IN DURATION").'","'._QXZ("IDLE TIME").'","'._QXZ("TALK TIME").'","'._QXZ("WRAP UP").'","'._QXZ("RINGING").'","'._QXZ("DAILING").'","'._QXZ("BREAK TIME").'","'._QXZ("AHT").'","'._QXZ("LUNCH TIME").'","'._QXZ("TEA TIME").'","'._QXZ("WASHROOM").'","'._QXZ("TRAINING").'","'._QXZ("FIRST LOGIN").'","'._QXZ("OUTBOUND").'","'._QXZ("CONNECTED").'","'._QXZ("NOT CONNECTED").'","'._QXZ("TOTAL OUT CALLS").'","'._QXZ("DNC").'","'._QXZ("REDAIL").'","'._QXZ("AUTO WRAPUP").'","'._QXZ("WTR").'","'._QXZ("NC").'","'._QXZ("RNR").'","'._QXZ("PAID").'","'._QXZ("PTP").'","'._QXZ("ISSUE").'","'._QXZ("FPTP").'","'._QXZ("EXPRD").'","'._QXZ("CB").'","'._QXZ("LM").'","'._QXZ("BRPTP").'","'._QXZ("NCHP").'","'._QXZ("NCHN").'","'._QXZ("WIP").'"';
}
...
//	$ASCII_text.="+-----------------+----------+----------------------+----------------------+".$BBD_header."--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
	...
	<td>"._QXZ("AGENT ID")."</td>
	<td>"._QXZ("PROCESS")."</td>
	<td>"._QXZ("LOGGED IN DURATION")."</td>
	<td>"._QXZ("IDLE TIME")."</td>
	<td>"._QXZ("TALK TIME")."</td>
	<td>"._QXZ("WRAP UP")."</td>
	<td>"._QXZ("RINGING")."</td>
	<td>"._QXZ("DAILING")."</td>
	<td>"._QXZ("BREAK TIME")."</td>
	<td>"._QXZ("AHT")."</td>
	<td>"._QXZ("LUNCH TIME")."</td>
	<td>"._QXZ("TEA TIME")."</td>
	<td>"._QXZ("WASHROOM")."</td>
	<td>"._QXZ("TRAINING")."</td>
	<td>"._QXZ("FIRST LOGIN")."</td>
	<td>"._QXZ("OUTBOUND")."</td>
	<td>"._QXZ("CONNECTED")."</td>
	<td>"._QXZ("NOT CONNECTED")."</td>
	<td>"._QXZ("TOTAL OUT CALLS")."</td>
	<td>"._QXZ("DNC")."</td>
	<td>"._QXZ("REDAIL")."</td>
	<td>"._QXZ("AUTO WRAPUP")."</td>
	<td>"._QXZ("WTR")."</td>
	<td>"._QXZ("NC")."</td>
	<td>"._QXZ("RNR")."</td>
	<td>"._QXZ("PAID")."</td>
...
$sel_login_time = "select DATE(event_date) as login_date, TIME(event_date) as logintime from vicidial_user_log where event_date >='$query_date_BEGIN' and event_date <= '$query_date_END' and user='$SuserName' and event='LOGIN' GROUP BY(login_date)";
$res_login_time = mysqli_query($link,$sel_login_time);
$logindt = array();
$loginTime = array();
while($row_login_time = mysqli_fetch_array($res_login_time))
{
$logindt[] = $row_login_time[0];
$loginTime[] = $row_login_time[1];
}
$actuallogin = implode(",",$logindt);
$actuallogintime = implode(",",$loginTime);



// ############ logout time ##########
$sel_logout_time = "select max(event_date) as userdate, DATE(event_date) as logout_date, TIME(event_date) as logouttime from vicidial_user_log where event_date >='$query_date_BEGIN' and event_date <= '$query_date_END' and user='$SuserName' and event='LOGOUT' GROUP BY(logout_date)";
$res_logout_time = mysqli_query($link,$sel_logout_time);
$logoutdt = array();
$logoutTime = array();
while($row_logout_time = mysqli_fetch_array($res_logout_time))
{
	$logoutoveralldatetime = $row_logout_time[0];
	$datetime = explode(" ",$logoutoveralldatetime);
	$logoutdt[] = $datetime[0];
$logoutTime[] = $datetime[1];
}

$actuallogout = implode(",",$logoutdt);
$actuallogouttime = implode(",",$logoutTime);
$our_array = explode(",",$actuallogin);
$our_array_time = explode(",",$actuallogintime);
$our_logout = explode(",",$actuallogout);
$our_logout_time = explode(",",$actuallogouttime);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($our_logout);$j++)
{
if($our_array[$i]==$our_logout[$j])
{
$temp = $our_logout[$i];
$our_logout[$i] = $our_logout[$j];
$our_logout[$j] = $temp;
$temp_time = $our_logout_time[$i];
$our_logout_time[$i] = $our_logout_time[$j];
$our_logout_time[$j] = $temp_time;
}
}
}

// ############ Total Calls ############ //
$sel_outCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' GROUP BY event_date";
$res_outCall = mysqli_query($link,$sel_outCall);
$no_outCall = array();
$calldate = array();
while($row_outCall = mysqli_fetch_array($res_outCall))
{
$no_outCall[] = $row_outCall[0];
$calldate[] = $row_outCall[1];
}
$outcalls = implode(",",$no_outCall);
$out_calls_array = explode(",",$outcalls);
$our_array = explode(",",$actuallogin);
$call_out_date = implode(",",$calldate);
$call_date_array = explode(",",$call_out_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_out = $out_calls_array[$i];
$out_calls_array[$i] = $out_calls_array[$j];
$out_calls_array[$j] = $temp_out;
}
}
}

// ############ Connected Calls ############ //
$sel_connectCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38!='NC' and field38!='' GROUP BY event_date";
$res_connectCall = mysqli_query($link,$sel_connectCall);
$no_connectCall = array();
$calldate = array();
while($row_connectCall = mysqli_fetch_array($res_connectCall))
{
$no_connectCall[] = $row_connectCall[0];
$calldate[] = $row_connectCall[1];
}
$connectcalls = implode(",",$no_connectCall);
$connect_calls_array = explode(",",$connectcalls);
$our_array = explode(",",$actuallogin);
$call_connect_date = implode(",",$calldate);
$call_date_array = explode(",",$call_connect_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_connect = $connect_calls_array[$i];
$connect_calls_array[$i] = $connect_calls_array[$j];
$connect_calls_array[$j] = $temp_connect;
}
}
}

// ############ Not Connected Calls ############ //
$sel_notconnectCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='NC' GROUP BY event_date";
$res_notconnectCall = mysqli_query($link,$sel_notconnectCall);
$no_notconnectCall = array();
$calldate = array();
while($row_notconnectCall = mysqli_fetch_array($res_notconnectCall))
{
$no_notconnectCall[] = $row_notconnectCall[0];
$calldate[] = $row_notconnectCall[1];
}
$notconnectcalls = implode(",",$no_notconnectCall);
$notconnect_calls_array = explode(",",$notconnectcalls);
$our_array = explode(",",$actuallogin);
$call_notconnect_date = implode(",",$calldate);
$call_date_array = explode(",",$call_notconnect_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_notconnect = $notconnect_calls_array[$i];
$notconnect_calls_array[$i] = $notconnect_calls_array[$j];
$notconnect_calls_array[$j] = $temp_notconnect;
}
}
}

// ############ DNC Calls ############ //
$sel_DNCCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='DNC' GROUP BY event_date";
$res_DNCCall = mysqli_query($link,$sel_DNCCall);
$no_DNCCall = array();
$calldate = array();
while($row_DNCCall = mysqli_fetch_array($res_DNCCall))
{
$no_DNCCall[] = $row_DNCCall[0];
$calldate[] = $row_DNCCall[1];
}
$DNCcalls = implode(",",$no_DNCCall);
$DNC_calls_array = explode(",",$DNCcalls);
$our_array = explode(",",$actuallogin);
$call_DNC_date = implode(",",$calldate);
$call_date_array = explode(",",$call_DNC_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_DNC = $DNC_calls_array[$i];
$DNC_calls_array[$i] = $DNC_calls_array[$j];
$DNC_calls_array[$j] = $temp_DNC;
}
}
}

// ############ WTR Calls ############ //
$sel_WTRCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='WTR' GROUP BY event_date";
$res_WTRCall = mysqli_query($link,$sel_WTRCall);
$no_WTRCall = array();
$calldate = array();
while($row_WTRCall = mysqli_fetch_array($res_WTRCall))
{
$no_WTRCall[] = $row_WTRCall[0];
$calldate[] = $row_WTRCall[1];
}
$WTRcalls = implode(",",$no_WTRCall);
$WTR_calls_array = explode(",",$WTRcalls);
$our_array = explode(",",$actuallogin);
$call_WTR_date = implode(",",$calldate);
$call_date_array = explode(",",$call_WTR_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_WTR = $WTR_calls_array[$i];
$WTR_calls_array[$i] = $WTR_calls_array[$j];
$WTR_calls_array[$j] = $temp_WTR;
}
}
}

// ############ RNR Calls ############ //
$sel_RNRCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='RNR' GROUP BY event_date";
$res_RNRCall = mysqli_query($link,$sel_RNRCall);
$no_RNRCall = array();
$calldate = array();
while($row_RNRCall = mysqli_fetch_array($res_RNRCall))
{
$no_RNRCall[] = $row_RNRCall[0];
$calldate[] = $row_RNRCall[1];
}
$RNRcalls = implode(",",$no_RNRCall);
$RNR_calls_array = explode(",",$RNRcalls);
$our_array = explode(",",$actuallogin);
$call_RNR_date = implode(",",$calldate);
$call_date_array = explode(",",$call_RNR_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_RNR = $RNR_calls_array[$i];
$RNR_calls_array[$i] = $RNR_calls_array[$j];
$RNR_calls_array[$j] = $temp_RNR;
}
}
}

// ############ PAID Calls ############ //
$sel_PAIDCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='PAID' GROUP BY event_date";
$res_PAIDCall = mysqli_query($link,$sel_PAIDCall);
$no_PAIDCall = array();
$calldate = array();
while($row_PAIDCall = mysqli_fetch_array($res_PAIDCall))
{
$no_PAIDCall[] = $row_PAIDCall[0];
$calldate[] = $row_PAIDCall[1];
}
$PAIDcalls = implode(",",$no_PAIDCall);
$PAID_calls_array = explode(",",$PAIDcalls);
$our_array = explode(",",$actuallogin);
$call_PAID_date = implode(",",$calldate);
$call_date_array = explode(",",$call_PAID_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_PAID = $PAID_calls_array[$i];
$PAID_calls_array[$i] = $PAID_calls_array[$j];
$PAID_calls_array[$j] = $temp_PAID;
}
}
}

// ############ PTP Calls ############ //
$sel_PTPCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='PTP' GROUP BY event_date";
$res_PTPCall = mysqli_query($link,$sel_PTPCall);
$no_PTPCall = array();
$calldate = array();
while($row_PTPCall = mysqli_fetch_array($res_PTPCall))
{
$no_PTPCall[] = $row_PTPCall[0];
$calldate[] = $row_PTPCall[1];
}
$PTPcalls = implode(",",$no_PTPCall);
$PTP_calls_array = explode(",",$PTPcalls);
$our_array = explode(",",$actuallogin);
$call_PTP_date = implode(",",$calldate);
$call_date_array = explode(",",$call_PTP_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_PTP = $PTP_calls_array[$i];
$PTP_calls_array[$i] = $PTP_calls_array[$j];
$PTP_calls_array[$j] = $temp_PTP;
}
}
}

// ############ ISSUE Calls ############ //
$sel_ISSUECall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='ISSUE' GROUP BY event_date";
$res_ISSUECall = mysqli_query($link,$sel_ISSUECall);
$no_ISSUECall = array();
$calldate = array();
while($row_ISSUECall = mysqli_fetch_array($res_ISSUECall))
{
$no_ISSUECall[] = $row_ISSUECall[0];
$calldate[] = $row_ISSUECall[1];
}
$ISSUEcalls = implode(",",$no_ISSUECall);
$ISSUE_calls_array = explode(",",$ISSUEcalls);
$our_array = explode(",",$actuallogin);
$call_ISSUE_date = implode(",",$calldate);
$call_date_array = explode(",",$call_ISSUE_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_ISSUE = $ISSUE_calls_array[$i];
$ISSUE_calls_array[$i] = $ISSUE_calls_array[$j];
$ISSUE_calls_array[$j] = $temp_ISSUE;
}
}
}

// ############ FPTP Calls ############ //
$sel_FPTPCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='FPTP' GROUP BY event_date";
$res_FPTPCall = mysqli_query($link,$sel_FPTPCall);
$no_FPTPCall = array();
$calldate = array();
while($row_FPTPCall = mysqli_fetch_array($res_FPTPCall))
{
$no_FPTPCall[] = $row_FPTPCall[0];
$calldate[] = $row_FPTPCall[1];
}
$FPTPcalls = implode(",",$no_FPTPCall);
$FPTP_calls_array = explode(",",$FPTPcalls);
$our_array = explode(",",$actuallogin);
$call_FPTP_date = implode(",",$calldate);
$call_date_array = explode(",",$call_FPTP_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_FPTP = $FPTP_calls_array[$i];
$FPTP_calls_array[$i] = $FPTP_calls_array[$j];
$FPTP_calls_array[$j] = $temp_FPTP;
}
}
}

// ############ EXPRD Calls ############ //
$sel_EXPRDCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='EXPRD' GROUP BY event_date";
$res_EXPRDCall = mysqli_query($link,$sel_EXPRDCall);
$no_EXPRDCall = array();
$calldate = array();
while($row_EXPRDCall = mysqli_fetch_array($res_EXPRDCall))
{
$no_EXPRDCall[] = $row_EXPRDCall[0];
$calldate[] = $row_EXPRDCall[1];
}
$EXPRDcalls = implode(",",$no_EXPRDCall);
$EXPRD_calls_array = explode(",",$EXPRDcalls);
$our_array = explode(",",$actuallogin);
$call_EXPRD_date = implode(",",$calldate);
$call_date_array = explode(",",$call_EXPRD_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_EXPRD = $EXPRD_calls_array[$i];
$EXPRD_calls_array[$i] = $EXPRD_calls_array[$j];
$EXPRD_calls_array[$j] = $temp_EXPRD;
}
}
}

// ############ CB Calls ############ //
$sel_CBCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='CB' GROUP BY event_date";
$res_CBCall = mysqli_query($link,$sel_CBCall);
$no_CBCall = array();
$calldate = array();
while($row_CBCall = mysqli_fetch_array($res_CBCall))
{
$no_CBCall[] = $row_CBCall[0];
$calldate[] = $row_CBCall[1];
}
$CBcalls = implode(",",$no_CBCall);
$CB_calls_array = explode(",",$CBcalls);
$our_array = explode(",",$actuallogin);
$call_CB_date = implode(",",$calldate);
$call_date_array = explode(",",$call_CB_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_CB = $CB_calls_array[$i];
$CB_calls_array[$i] = $CB_calls_array[$j];
$CB_calls_array[$j] = $temp_CB;
}
}
}

// ############ LM Calls ############ //
$sel_LMCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='LM' GROUP BY event_date";
$res_LMCall = mysqli_query($link,$sel_LMCall);
$no_LMCall = array();
$calldate = array();
while($row_LMCall = mysqli_fetch_array($res_LMCall))
{
$no_LMCall[] = $row_LMCall[0];
$calldate[] = $row_LMCall[1];
}
$LMcalls = implode(",",$no_LMCall);
$LM_calls_array = explode(",",$LMcalls);
$our_array = explode(",",$actuallogin);
$call_LM_date = implode(",",$calldate);
$call_date_array = explode(",",$call_LM_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_LM = $LM_calls_array[$i];
$LM_calls_array[$i] = $LM_calls_array[$j];
$LM_calls_array[$j] = $temp_LM;
}
}
}
...
// ############ BRPTP Calls ############ //
$sel_BRPTPCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='BRPTP' GROUP BY event_date";
$res_BRPTPCall = mysqli_query($link,$sel_BRPTPCall);
$no_BRPTPCall = array();
$calldate = array();
while($row_BRPTPCall = mysqli_fetch_array($res_BRPTPCall))
{
$no_BRPTPCall[] = $row_BRPTPCall[0];
$calldate[] = $row_BRPTPCall[1];
}
$BRPTPcalls = implode(",",$no_BRPTPCall);
$BRPTP_calls_array = explode(",",$BRPTPcalls);
$our_array = explode(",",$actuallogin);
$call_BRPTP_date = implode(",",$calldate);
$call_date_array = explode(",",$call_BRPTP_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_BRPTP = $BRPTP_calls_array[$i];
$BRPTP_calls_array[$i] = $BRPTP_calls_array[$j];
$BRPTP_calls_array[$j] = $temp_BRPTP;
}
}
}

// ############ NCHP Calls ############ //
$sel_NCHPCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='NCHP' GROUP BY event_date";
$res_NCHPCall = mysqli_query($link,$sel_NCHPCall);
$no_NCHPCall = array();
$calldate = array();
while($row_NCHPCall = mysqli_fetch_array($res_NCHPCall))
{
$no_NCHPCall[] = $row_NCHPCall[0];
$calldate[] = $row_NCHPCall[1];
}
$NCHPcalls = implode(",",$no_NCHPCall);
$NCHP_calls_array = explode(",",$NCHPcalls);
$our_array = explode(",",$actuallogin);
$call_NCHP_date = implode(",",$calldate);
$call_date_array = explode(",",$call_NCHP_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_NCHP = $NCHP_calls_array[$i];
$NCHP_calls_array[$i] = $NCHP_calls_array[$j];
$NCHP_calls_array[$j] = $temp_NCHP;
}
}
}
...
// ############ NCHN Calls ############ //
$sel_NCHNCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='NCHN' GROUP BY event_date";
$res_NCHNCall = mysqli_query($link,$sel_NCHNCall);
$no_NCHNCall = array();
$calldate = array();
while($row_NCHNCall = mysqli_fetch_array($res_NCHNCall))
{
$no_NCHNCall[] = $row_NCHNCall[0];
$calldate[] = $row_NCHNCall[1];
}
$NCHNcalls = implode(",",$no_NCHNCall);
$NCHN_calls_array = explode(",",$NCHNcalls);
$our_array = explode(",",$actuallogin);
$call_NCHN_date = implode(",",$calldate);
$call_date_array = explode(",",$call_NCHN_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_NCHN = $NCHN_calls_array[$i];
$NCHN_calls_array[$i] = $NCHN_calls_array[$j];
$NCHN_calls_array[$j] = $temp_NCHN;
}
}
}
...
// ############ WIP Calls ############ //
$sel_WIPCall = "select count(*) as noofcalls,DATE(call_date) as event_date  from vicidial_log where call_date >='$query_date_BEGIN' and call_date <= '$query_date_END' and user='$SuserName' and field38='WIP' GROUP BY event_date";
$res_WIPCall = mysqli_query($link,$sel_WIPCall);
$no_WIPCall = array();
$calldate = array();
while($row_WIPCall = mysqli_fetch_array($res_WIPCall))
{
$no_WIPCall[] = $row_WIPCall[0];
$calldate[] = $row_WIPCall[1];
}
$WIPcalls = implode(",",$no_WIPCall);
$WIP_calls_array = explode(",",$WIPcalls);
$our_array = explode(",",$actuallogin);
$call_WIP_date = implode(",",$calldate);
$call_date_array = explode(",",$call_WIP_date);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($call_date_array);$j++)
{
if($our_array[$i]==$call_date_array[$j])
{
$temp_WIP = $WIP_calls_array[$i];
$WIP_calls_array[$i] = $WIP_calls_array[$j];
$WIP_calls_array[$j] = $temp_WIP;
}
}
}
...
$sel_lg_campaign = "select campaign_id, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName'  GROUP BY event_date";
$res_lg_campaign = mysqli_query($link,$sel_lg_campaign);
$lg_campaign = array();
$lg_date = array();
while($row_lg_campaign = mysqli_fetch_array($res_lg_campaign))
{
$lg_campaign[] = $row_lg_campaign[0];
$lg_date[] = $row_lg_campaign[1];
//$lg_time[] = gmdate("H:i:s", $lg_time_sec);
}
$lg_campaign = implode(",",$lg_campaign);
$lg_campaign_array = explode(",",$lg_campaign);
$lgdate = implode(",",$lg_date);
$lg_date_array = explode(",",$lgdate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($lg_date_array);$j++)
{
if($our_array[$i]==$lg_date_array[$j])
{
$lgcampaign = $lg_campaign_array[$i];
$lg_campaign_array[$i] = $lg_campaign_array[$j];
$lg_campaign_array[$j] = $lgcampaign;
}
}
}
...
$sel_lb_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' and sub_status IN('LB') GROUP BY event_date";
$res_lb_time = mysqli_query($link,$sel_lb_time);
$lbtimetest = array();
$lbtimedate = array();
while($row_lb_time = mysqli_fetch_array($res_lb_time))
{
$lbtimesec = $row_lb_time[0];
$lbtimedate[] = $row_lb_time[1];
$lbtimetest[] = gmdate("H:i:s", $lbtimesec);
}
$lbtime = implode(",",$lbtimetest);
$lb_time_array = explode(",",$lbtime);
$lbdate = implode(",",$lbtimedate);
$lb_date_array = explode(",",$lbdate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($lb_date_array);$j++)
{
if($our_array[$i]==$lb_date_array[$j])
{
$lb_time = $lb_time_array[$i];
$lb_time_array[$i] = $lb_time_array[$j];
$lb_time_array[$j] = $lb_time;
}
}
}
...
$total_sel_lb_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and sub_status IN('LB') GROUP BY event_date";
$total_res_lb_time = mysqli_query($link,$total_sel_lb_time);
$total_lb_time_sec = 0;
while($total_row_lb_time = mysqli_fetch_array($total_res_lb_time))
{
$total_lb_time_sec = $total_lb_time_sec + $total_row_lb_time[0];
}
$lb_hours = floor($total_lb_time_sec / 3600);
$lb_minutes = floor(($total_lb_time_sec / 60) % 60);
$lb_seconds = $total_lb_time_sec % 60;
$total_lb_time = "$lb_hours:$lb_minutes:$lb_seconds";

// #### Manual Dial Time ###//

$sel_md_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' and sub_status IN('MD') GROUP BY event_date";
$res_md_time = mysqli_query($link,$sel_md_time);
$md_time = array();
$mdtimedate = array();
while($row_md_time = mysqli_fetch_array($res_md_time))
{
$md_time_sec = $row_md_time[0];
$mdtimedate[] = $row_md_time[1];
$md_time[] = gmdate("H:i:s", $md_time_sec);
}
$md_time = implode(",",$md_time);
$md_time_array = explode(",",$md_time);
$mddate = implode(",",$mdtimedate);
$md_date_array = explode(",",$mddate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($md_date_array);$j++)
{
if($our_array[$i]==$md_date_array[$j])
{
$mdtime = $md_time_array[$i];
$md_time_array[$i] = $md_time_array[$j];
$md_time_array[$j] = $mdtime;
}
}
}
$total_sel_md_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and sub_status IN('MD') GROUP BY event_date";
$total_res_md_time = mysqli_query($link,$total_sel_md_time);
$total_md_time_sec = 0;
while($total_row_md_time = mysqli_fetch_array($total_res_md_time))
{
$total_md_time_sec = $total_md_time_sec + $total_row_md_time[0];
}
$md_hours = floor($total_md_time_sec / 3600);
$md_minutes = floor(($total_md_time_sec / 60) % 60);
$md_seconds = $total_md_time_sec % 60;
$total_md_time = "$md_hours:$md_minutes:$md_seconds";


// #### Bio Time ###//

$sel_lgd_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' and sub_status IN('BB') GROUP BY event_date";
$res_lgd_time = mysqli_query($link,$sel_lgd_time);
$lgd_time = array();
$lgd_date = array();
while($row_lgd_time = mysqli_fetch_array($res_lgd_time))
{
$lgd_time_sec = $row_lgd_time[0];
$lgd_date[] = $row_lgd_time[1];
$lgd_time[] = gmdate("H:i:s", $lgd_time_sec);
}
$lgd_time = implode(",",$lgd_time);
$lgd_time_array = explode(",",$lgd_time);
$lgddate = implode(",",$lgd_date);
$lgd_date_array = explode(",",$lgddate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($lgd_date_array);$j++)
{
if($our_array[$i]==$lgd_date_array[$j])
{
$lgdtime = $lgd_time_array[$i];
$lgd_time_array[$i] = $lgd_time_array[$j];
$lgd_time_array[$j] = $lgdtime;
}
}
}
$total_sel_lgd_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and sub_status IN('BIO') GROUP BY event_date";
$total_res_lgd_time = mysqli_query($link,$total_sel_lgd_time);
$total_lgd_time_sec = 0;
while($total_row_lgd_time = mysqli_fetch_array($total_res_lgd_time))
{
$total_lgd_time_sec = $total_lgd_time_sec + $total_row_lgd_time[0];
}
$lgd_hours = floor($total_lgd_time_sec / 3600);
$lgd_minutes = floor(($total_lgd_time_sec / 60) % 60);
$lgd_seconds = $total_lgd_time_sec % 60;
$total_lgd_time = "$lgd_hours:$lgd_minutes:$lgd_seconds";

// #### Traing Time ###//

$sel_lg_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' and sub_status IN('TR') GROUP BY event_date";
$res_lg_time = mysqli_query($link,$sel_lg_time);
$lg_time = array();
$lg_date = array();
while($row_lg_time = mysqli_fetch_array($res_lg_time))
{
$lg_time_sec = $row_lg_time[0];
$lg_date[] = $row_lg_time[1];
$lg_time[] = gmdate("H:i:s", $lg_time_sec);
}
$lg_time = implode(",",$lg_time);
$lg_time_array = explode(",",$lg_time);
$lgdate = implode(",",$lg_date);
$lg_date_array = explode(",",$lgdate);
for($i=0;$i<count($our_array);$i++)
{
...
if($our_array[$i]==$lg_date_array[$j])
{
$lgtime = $lg_time_array[$i];
$lg_time_array[$i] = $lg_time_array[$j];
$lg_time_array[$j] = $lgtime;
}
}
}
$total_sel_lgd_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and sub_status IN('BIO') GROUP BY event_date";
...
$sel_gd_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' and sub_status IN('TB') GROUP BY event_date";
$res_gd_time = mysqli_query($link,$sel_gd_time);
$gd_time = array();
$gd_date = array();
while($row_gd_time = mysqli_fetch_array($res_gd_time))
{
$gd_time_sec = $row_gd_time[0];
$gd_date[] = $row_gd_time[1];
$gd_time[] = gmdate("H:i:s", $gd_time_sec);
}
$gd_time = implode(",",$gd_time);
$gd_time_array = explode(",",$gd_time);
$gddate = implode(",",$gd_date);
$gd_date_array = explode(",",$gddate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($gd_date_array);$j++)
{
if($our_array[$i]==$gd_date_array[$j])
{
$gdtime = $gd_time_array[$i];
$gd_time_array[$i] = $gd_time_array[$j];
$gd_time_array[$j] = $gdtime;
}
}
}
$total_sel_lgd_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and sub_status IN('BIO') GROUP BY event_date";
...
$sel_login_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' and sub_status IN('LOGIN') GROUP BY event_date";
$res_login_time = mysqli_query($link,$sel_login_time);
$login_time = array();
$login_date = array();
while($row_login_time = mysqli_fetch_array($res_login_time))
{
$login_time_sec = $row_login_time[0];
$login_date[] = $row_login_time[1];
$login_time[] = gmdate("H:i:s", $login_time_sec);
}
$login_time = implode(",",$login_time);
$login_time_array = explode(",",$login_time);
$logindate = implode(",",$login_date);
$login_date_array = explode(",",$logindate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($login_date_array);$j++)
{
if($our_array[$i]==$login_date_array[$j])
{
$logintime = $login_time_array[$i];
$login_time_array[$i] = $login_time_array[$j];
$login_time_array[$j] = $logintime;
}
}
}
$total_sel_login_time = "select sum(pause_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and sub_status IN('LOGIN') GROUP BY event_date";
$total_res_login_time = mysqli_query($link,$total_sel_login_time);
//$total_login_time_sec = 0;
while($total_row_login_time = mysqli_fetch_array($total_res_login_time))
{
$total_login_time_sec = $total_login_time_sec + $total_row_login_time[0];
}
$login_hours = floor($total_login_time_sec / 3600);
$login_minutes = floor(($total_login_time_sec / 60) % 60);
$login_seconds = $total_login_time_sec % 60;
$total_login_time = "$login_hours:$login_minutes:$login_seconds";
/** Total Break Time **/

for($i=0;$i<count($our_array);$i++)
{
$lb_time_array_exp = explode(':', $lb_time_array[$i]);
$lb_sec[$i] = ($lb_time_array_exp[0] * 3600) + ($lb_time_array_exp[1] * 60) + $lb_time_array_exp[2];
$login_time_array_exp = explode(':', $login_time_array[$i]);
$login_sec[$i] = ($login_time_array_exp[0] * 3600) + ($login_time_array_exp[1] * 60) + $login_time_array_exp[2];
$md_time_array_exp = explode(':', $md_time_array[$i]);
$md_sec[$i] = ($md_time_array_exp[0] * 3600) + ($md_time_array_exp[1] * 60) + $md_time_array_exp[2];
$lgd_time_array_exp = explode(':', $lgd_time_array[$i]);
$lgd_sec[$i] = ($lgd_time_array_exp[0] * 3600) + ($lgd_time_array_exp[1] * 60) + $lgd_time_array_exp[2];

$total_break_time_sec[$i] = $lb_sec[$i] + $login_sec[$i] + $md_sec[$i] + $lgd_sec[$i];
$total_break_time[$i] = gmdate("H:i:s", $total_break_time_sec[$i]);
$tot_total_break_time_sec = $tot_total_break_time_sec + $total_break_time_sec[$i];
//echo $total_break_time[$i];
}
$total_break_time_hours = floor($tot_total_break_time_sec / 3600);
$total_break_time_minutes = floor(($tot_total_break_time_sec / 60) % 60);
$total_break_time_seconds = $tot_total_break_time_sec % 60;
$tot_total_break_time = "$total_break_time_hours:$total_break_time_minutes:$total_break_time_seconds";
//$tot_total_break_time = gmdate("H:i:s", $tot_total_break_time_sec);

/** Wait Time Calculations **/

$sel_wt_time = "select sum(wait_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' GROUP BY event_date";
$res_wt_time = mysqli_query($link,$sel_wt_time);
$wt_time = array();
$wt_date = array();
while($row_wt_time = mysqli_fetch_array($res_wt_time))
{
$wt_time_sec = $row_wt_time[0];
$wt_date[] = $row_wt_time[1];
$wt_time[] = gmdate("H:i:s", $wt_time_sec);
}
$wt_time = implode(",",$wt_time);
$wt_time_array = explode(",",$wt_time);
$wtdate = implode(",",$wt_date);
$wt_date_array = explode(",",$wtdate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($wt_date_array);$j++)
{
if($our_array[$i]==$wt_date_array[$j])
{
$wttime = $wt_time_array[$i];
$wt_time_array[$i] = $wt_time_array[$j];
$wt_time_array[$j] = $wttime;
}
}
}
$total_sel_wt_time = "select sum(wait_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_wt_time = mysqli_query($link,$total_sel_wt_time);
$total_wt_time_sec = 0;
while($total_row_wt_time = mysqli_fetch_array($total_res_wt_time))
{
$total_wt_time_sec = $total_wt_time_sec + $total_row_wt_time[0];
}
$wt_hours = floor($total_wt_time_sec / 3600);
$wt_minutes = floor(($total_wt_time_sec / 60) % 60);
$wt_seconds = $total_wt_time_sec % 60;
$total_wt_time = "$wt_hours:$wt_minutes:$wt_seconds";
for($i=0;$i<count($our_array);$i++)
{
/** Wait Average Calculations **/
	$wt_time_array_exp[$i] = explode(':', $wt_time_array[$i]);
$wt_sec[$i] = ($wt_time_array_exp[$i][0] * 3600) + ($wt_time_array_exp[$i][1] * 60) + ($wt_time_array_exp[$i][2]);
	$wait_avg_sec[$i] = $wt_sec[$i]/2;
	$wait_avg[$i] = gmdate("H:i:s", $wait_avg_sec[$i]);
}

$total_sel_wtavg_time = "select sum(wait_sec/2) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_wtavg_time = mysqli_query($link,$total_sel_wtavg_time);
$total_wtavg_time_sec = 0;
while($total_row_wtavg_time = mysqli_fetch_array($total_res_wtavg_time))
{
$total_wtavg_time_sec = ($total_wtavg_time_sec + $total_row_wtavg_time[0]);
}
$count_rec = $count_rec + count($our_array);
$total_avg_sec = ($total_wtavg_time_sec)/$count_rec;
$wt_avg_hours = floor($total_avg_sec / 3600);
$wt_avg_minutes = floor(($total_avg_sec / 60) % 60);
$wt_avg_seconds = $total_avg_sec % 60;
$total_avg = "$wt_avg_hours:$wt_avg_minutes:$wt_avg_seconds";
	
/** Pause Time Calculations **/

$sel_pt_time = "select pause_sec as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' GROUP BY event_date";
$res_pt_time = mysqli_query($link,$sel_pt_time);
$pt_time = array();
$pt_date = array();
while($row_pt_time = mysqli_fetch_array($res_pt_time))
{
$pt_time_sec = $row_pt_time[0];
$pt_date[] = $row_pt_time[1];
$pt_time[] = gmdate("H:i:s", $pt_time_sec);
}
$pt_time = implode(",",$pt_time);
$pt_time_array = explode(",",$pt_time);
$ptdate = implode(",",$pt_date);
$pt_date_array = explode(",",$ptdate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($pt_date_array);$j++)
{
if($our_array[$i]==$pt_date_array[$j])
{
$pttime = $pt_time_array[$i];
$pt_time_array[$i] = $pt_time_array[$j];
$pt_time_array[$j] = $pttime;
}
}
}
$total_sel_pt_time = "select pause_sec as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_pt_time = mysqli_query($link,$total_sel_pt_time);
$total_pt_time_sec = 0;
while($total_row_pt_time = mysqli_fetch_array($total_res_pt_time))
{
$total_pt_time_sec = $total_pt_time_sec + $total_row_pt_time[0];
}
$pt_hours = floor($total_pt_time_sec / 3600);
$pt_minutes = floor(($total_pt_time_sec / 60) % 60);
$pt_seconds = $total_pt_time_sec % 60;
$total_pt_time = "$pt_hours:$pt_minutes:$pt_seconds";
//$total_pt_time = gmdate("H:i:s", $total_pt_time_sec);
for($i=0;$i<count($our_array);$i++)
{
/** Pause Average Calculations **/
	$pt_time_array_exp[$i] = explode(':', $pt_time_array[$i]);
$pt_sec[$i] = ($pt_time_array_exp[$i][0] * 3600) + ($pt_time_array_exp[$i][1] * 60) + ($pt_time_array_exp[$i][2]);
	$pt_avg_sec[$i] = $pt_sec[$i]/2;
	$pt_avg[$i] = gmdate("H:i:s", $pt_avg_sec[$i]);
}
$total_sel_ptavg_time = "select (pause_sec/2) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_ptavg_time = mysqli_query($link,$total_sel_ptavg_time);
$total_ptavg_time_sec = 0;
while($total_row_ptavg_time = mysqli_fetch_array($total_res_ptavg_time))
{
$total_ptavg_time_sec = ($total_ptavg_time_sec + $total_row_ptavg_time[0]);
}
$total_avg_pause_sec = ($total_ptavg_time_sec)/$count_rec;
$pt_avg_hours = floor($total_avg_pause_sec / 3600);
$pt_avg_minutes = floor(($total_avg_pause_sec / 60) % 60);
$pt_avg_seconds = $total_avg_pause_sec % 60;
$total_avg_pause = "$pt_avg_hours:$pt_avg_minutes:$pt_avg_seconds";
//$total_avg_pause = gmdate("H:i:s", $total_avg_pause_sec);

/** Talk Time Calculations **/

$sel_talk_time = "select sum(talk_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' GROUP BY event_date";
$res_talk_time = mysqli_query($link,$sel_talk_time);
$talk_time = array();
$talk_date = array();
while($row_talk_time = mysqli_fetch_array($res_talk_time))
{
$talk_time_sec = $row_talk_time[0];
$talk_date[] = $row_talk_time[1];
$talk_time[] = gmdate("H:i:s", $talk_time_sec);
}
$talk_time = implode(",",$talk_time);
$talk_time_array = explode(",",$talk_time);
$talkdate = implode(",",$talk_date);
$talk_date_array = explode(",",$talkdate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($talk_date_array);$j++)
{
if($our_array[$i]==$talk_date_array[$j])
{
$talktime = $talk_time_array[$i];
$talk_time_array[$i] = $talk_time_array[$j];
$talk_time_array[$j] = $talktime;
}
}
}
$total_sel_talk_time = "select sum(talk_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_talk_time = mysqli_query($link,$total_sel_talk_time);
$total_talk_time_sec = 0;
while($total_row_talk_time = mysqli_fetch_array($total_res_talk_time))
{
$total_talk_time_sec = $total_talk_time_sec + $total_row_talk_time[0];
}
$talk_hours = floor($total_talk_time_sec / 3600);
$talk_minutes = floor(($total_talk_time_sec / 60) % 60);
$talk_seconds = $total_talk_time_sec % 60;
$total_talk_time = "$talk_hours:$talk_minutes:$talk_seconds";
//$total_talk_time = gmdate("H:i:s", $total_talk_time_sec);
for($i=0;$i<count($our_array);$i++)
{
/** Talk Average Calculations **/
	$talk_time_array_exp[$i] = explode(':', $talk_time_array[$i]);
$talk_sec[$i] = ($talk_time_array_exp[$i][0] * 3600) + ($talk_time_array_exp[$i][1] * 60) + ($talk_time_array_exp[$i][2]);
	$talk_avg_sec[$i] = $talk_sec[$i]/2;
	$talk_avg[$i] = gmdate("H:i:s", $talk_avg_sec[$i]);
	
}
$total_sel_talkavg_time = "select sum(talk_sec/2) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_talkavg_time = mysqli_query($link,$total_sel_talkavg_time);
$total_talkavg_time_sec = 0;

while($total_row_talkavg_time = mysqli_fetch_array($total_res_talkavg_time))
{
$total_talkavg_time_sec = ($total_talkavg_time_sec + $total_row_talkavg_time[0]);

}
$total_avg_talk_sec = ($total_talkavg_time_sec)/$count_rec;
$talk_avg_hours = floor($total_avg_talk_sec / 3600);
$talk_avg_minutes = floor(($total_avg_talk_sec / 60) % 60);
$talk_avg_seconds = $total_avg_talk_sec % 60;
$total_avg_talk = "$talk_avg_hours:$talk_avg_minutes:$talk_avg_seconds";
//$total_avg_talk = gmdate("H:i:s", $total_avg_talk_sec);

/** Disposition Time Calculations **/

$sel_dispo_time = "select sum(dispo_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' GROUP BY event_date";
$res_dispo_time = mysqli_query($link,$sel_dispo_time);
$dispo_time = array();
$dispo_date = array();
while($row_dispo_time = mysqli_fetch_array($res_dispo_time))
{
$dispo_time_sec = $row_dispo_time[0];
$dispo_date[] = $row_dispo_time[1];
$dispo_time[] = gmdate("H:i:s", $dispo_time_sec);
}
$dispo_time = implode(",",$dispo_time);
$dispo_time_array = explode(",",$dispo_time);
$dispodate = implode(",",$dispo_date);
$dispo_date_array = explode(",",$dispodate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($dispo_date_array);$j++)
{
if($our_array[$i]==$dispo_date_array[$j])
{
$dispotime = $dispo_time_array[$i];
$dispo_time_array[$i] = $dispo_time_array[$j];
$dispo_time_array[$j] = $dispotime;
}
}
}
$total_sel_dispo_time = "select sum(dispo_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_dispo_time = mysqli_query($link,$total_sel_dispo_time);
while($total_row_dispo_time = mysqli_fetch_array($total_res_dispo_time))
{
$total_dispo_time_sec = $total_dispo_time_sec + $total_row_dispo_time[0];
}
$dispo_hours = floor($total_dispo_time_sec / 3600);
$dispo_minutes = floor(($total_dispo_time_sec / 60) % 60);
$dispo_seconds = $total_dispo_time_sec % 60;
//$total_dispo_time = "$dispo_hours:$dispo_minutes:$dispo_seconds";
$total_dispo_time = gmdate("H:i:s", $total_dispo_time_sec);
for($i=0;$i<count($our_array);$i++)
{
/** Disposition Average Calculations **/
	$disp_time_array_exp[$i] = explode(':', $dispo_time_array[$i]);
$disp_sec[$i] = ($disp_time_array_exp[$i][0] * 3600) + ($disp_time_array_exp[$i][1] * 60) + ($disp_time_array_exp[$i][2]);
	$disp_avg_sec[$i] = $disp_sec[$i]/2;
	$disp_avg[$i] = gmdate("H:i:s", $disp_avg_sec[$i]);	
}
$total_sel_dispavg_time = "select sum(dispo_sec/2) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_dispavg_time = mysqli_query($link,$total_sel_dispavg_time);
$total_dispavg_time_sec = 0;

while($total_row_dispavg_time = mysqli_fetch_array($total_res_dispavg_time))
{
$total_dispavg_time_sec = ($total_dispavg_time_sec + $total_row_dispavg_time[0]);

}
$total_avg_disp_sec = ($total_dispavg_time_sec)/$count_rec;
$dispo_avg__hours = floor($total_avg_disp_sec / 3600);
$dispo_avg_minutes = floor(($total_avg_disp_sec / 60) % 60);
$dispo_avg_seconds = $total_avg_disp_sec % 60;
$total_avg_disp = "$dispo_avg__hours:$dispo_avg_minutes:$dispo_avg_seconds";
//$total_avg_disp = gmdate("H:i:s", $total_avg_disp_sec);

/** Dead Time Calculations **/

$sel_dead_time = "select sum(dead_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' and user='$SuserName' GROUP BY event_date";
$res_dead_time = mysqli_query($link,$sel_dead_time);
$dead_time = array();
$dead_date = array();
while($row_dead_time = mysqli_fetch_array($res_dead_time))
{
$dead_time_sec = $row_dead_time[0];
$dead_date[] = $row_dead_time[1];
$dead_time[] = gmdate("H:i:s", $dead_time_sec);
}
$dead_time = implode(",",$dead_time);
$dead_time_array = explode(",",$dead_time);
$deaddate = implode(",",$dead_date);
$dead_date_array = explode(",",$deaddate);
for($i=0;$i<count($our_array);$i++)
{
for($j=0;$j<count($dead_date_array);$j++)
{
if($our_array[$i]==$dead_date_array[$j])
{
$deadtime = $dead_time_array[$i];
$dead_time_array[$i] = $dead_time_array[$j];
$dead_time_array[$j] = $deadtime;
}
}
}
$total_sel_dead_time = "select sum(dead_sec) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_dead_time = mysqli_query($link,$total_sel_dead_time);
$total_dead_time_sec = 0;
while($total_row_dead_time = mysqli_fetch_array($total_res_dead_time))
{
$total_dead_time_sec = $total_dead_time_sec + $total_row_dead_time[0];
}
$dead_hours = floor($total_dead_time_sec / 3600);
$dead_minutes = floor(($total_dead_time_sec / 60) % 60);
$dead_seconds = $total_dead_time_sec % 60;
$total_dead_time = "$dead_hours:$dead_minutes:$dead_seconds";
//$total_dead_time = gmdate("H:i:s", $total_dead_time_sec);
for($i=0;$i<count($our_array);$i++)
{
/** Dead Average Calculations **/
	$dead_time_array_exp[$i] = explode(':', $dead_time_array[$i]);
$dead_sec[$i] = ($dead_time_array_exp[$i][0] * 3600) + ($dead_time_array_exp[$i][1] * 60) + ($dead_time_array_exp[$i][2]);
	$dead_avg_sec[$i] = $dead_sec[$i]/2;
	$dead_avg[$i] = gmdate("H:i:s", $dead_avg_sec[$i]);
}
$total_sel_deadavg_time = "select sum(dead_sec/2) as testsec, DATE(event_time) as event_date from ".$agent_log_table." where event_time >= '$query_date_BEGIN' and event_time <= '$query_date_END' GROUP BY event_date";
$total_res_deadavg_time = mysqli_query($link,$total_sel_deadavg_time);
$total_deadavg_time_sec = 0;
while($total_row_deadavg_time = mysqli_fetch_array($total_res_deadavg_time))
{
$total_deadavg_time_sec = ($total_deadavg_time_sec + $total_row_deadavg_time[0]);
}
$total_avg_dead_sec = ($total_deadavg_time_sec)/$count_rec;
$dead_avg_hours = floor($total_avg_dead_sec / 3600);
$dead_avg_minutes = floor(($total_avg_dead_sec / 60) % 60);
$dead_avg_seconds = $total_avg_dead_sec % 60;
$total_avg_dead = "$dead_avg_hours:$dead_avg_minutes:$dead_avg_seconds";
//$total_avg_dead = gmdate("H:i:s", $total_avg_dead_sec);
for($i=0;$i<count($our_array);$i++)
{
$dead_time_array_exp[$i] = explode(':', $dead_time_array[$i]);
$dead_sec[$i] = ($dead_time_array_exp[$i][0] * 3600) + ($dead_time_array_exp[$i][1] * 60) + ($dead_time_array_exp[$i][2]);
$talk_time_array_exp[$i] = explode(':', $talk_time_array[$i]);
$talk_sec[$i] = ($talk_time_array_exp[$i][0] * 3600) + ($talk_time_array_exp[$i][1] * 60) + ($talk_time_array_exp[$i][2]);
$wait_time_array_exp[$i] = explode(':', $wt_time_array[$i]);
$wait_sec[$i] = ($wait_time_array_exp[$i][0] * 3600) + ($wait_time_array_exp[$i][1] * 60) + ($wait_time_array_exp[$i][2]);
$pause_time_array_exp[$i] = explode(':', $pt_time_array[$i]);
$pause_sec[$i] = ($pause_time_array_exp[$i][0] * 3600) + ($pause_time_array_exp[$i][1] * 60) + ($pause_time_array_exp[$i][2]);
$dispo_time_array_exp[$i] = explode(':', $dispo_time_array[$i]);
$dispo_sec[$i] = ($dispo_time_array_exp[$i][0] * 3600) + ($dispo_time_array_exp[$i][1] * 60) + ($dispo_time_array_exp[$i][2]);
$customer_time_sec[$i] = $talk_sec[$i] - $dead_sec[$i];
$customer_time_avgsec[$i] = ($talk_sec[$i] - $dead_sec[$i])/2;
$customer_time[$i] = gmdate("H:i:s", $customer_time_sec[$i]);
$total_customer_time_sec = $total_customer_time_sec + $customer_time_sec[$i];
$total_avg_customer_time_sec = $total_avg_customer_time_sec + $customer_time_avgsec[$i];
$customer_avgtime[$i] = gmdate("H:i:s", $customer_time_avgsec[$i]);
$total_time_sec[$i] = $talk_sec[$i] + $dispo_sec[$i] + $wait_sec[$i] + $pause_sec[$i];
$total_time[$i] = gmdate("H:i:s", $total_time_sec[$i]);
$total_overall_time_sec = $total_overall_time_sec + $total_time_sec[$i];
}
$total_avg_customer_time_sec = ($total_avg_customer_time_sec)/$count_rec;
$customer_time_hours = floor($total_customer_time_sec / 3600);
$customer_time_minutes = floor(($total_customer_time_sec / 60) % 60);
$customer_time_seconds = $total_customer_time_sec % 60;
$total_customer_time = "$customer_time_hours:$customer_time_minutes:$customer_time_seconds";
$customer_avgtime_hours = floor($total_avg_customer_time_sec / 3600);
$customer_avgtime_minutes = floor(($total_avg_customer_time_sec / 60) % 60);
$customer_avgtime_seconds = $total_avg_customer_time_sec % 60;
$total_avg_customer_time = "$customer_avgtime_hours:$customer_avgtime_minutes:$customer_avgtime_seconds";
$overall_time_hours = floor($total_overall_time_sec / 3600);
$overall_time_minutes = floor(($total_overall_time_sec / 60) % 60);
$overall_time_seconds = $total_overall_time_sec % 60;
$total_overall_time = "$overall_time_hours:$overall_time_minutes:$overall_time_seconds";
//$total_customer_time = gmdate("H:i:s", $total_customer_time_sec);
//$total_avg_customer_time = gmdate("H:i:s", $total_avg_customer_time_sec);
//$total_overall_time = gmdate("H:i:s", $total_overall_time_sec);
...
$str_time = preg_replace("/^([\d]{1,2})\:([\d]{2})$/", "00:$1:$2", $talk_time_array[$i]);
...
$AHT_values = round($time_seconds/$out_calls_array[$i]);
$AHT_duration = gmdate("H:i:s", $AHT_values);

$total_out_calls = $connect_calls_array[$i]+$notconnect_calls_array[$i];

	$Toutput .= "<tr>
	<td>$our_array[$i]</td>
	<td>Banglore</td>
	<td>$Sfull_name</td>
	<td>$lg_campaign_array[$i]</td>
	<td>$total_time[$i]</td>
	<td> $dead_time_array[$i] </td>
	<td>$talk_time_array[$i]</td>
	<td> $dispo_time_array[$i] </td>
	<td>  </td>
	<td> </td>
	<td>$total_break_time[$i]</td>
	<td> $AHT_duration </td>
	<td>$lb_time_array[$i]</td>
	<td>$gd_time_array[$i]</td>
	<td>$lgd_time_array[$i] </td>
	<td>$lg_time_array[$i]</td>
	<td>$our_array[$i] $our_array_time[$i]</td>
	<td>$md_time_array[$i]</td>
	<td>$connect_calls_array[$i]</td>
	<td>$notconnect_calls_array[$i]</td>
	<td>$total_out_calls</td>
	<td>$DNC_calls_array[$i]</td>
	<td></td>
	<td></td>
	<td>$WTR_calls_array[$i]</td>
	<td>$notconnect_calls_array[$i]</td>
	<td>$RNR_calls_array[$i]</td>
	<td>$PAID_calls_array[$i]</td>
	<td>$PTP_calls_array[$i]</td>
	<td>$ISSUE_calls_array[$i]</td>
	<td>$FPTP_calls_array[$i]</td>
	<td>$EXPRD_calls_array[$i]</td>
	<td>$CB_calls_array[$i]</td>
	<td>$LM_calls_array[$i]</td>

	<td>$BRPTP_calls_array[$i]</td>
	<td>$NCHP_calls_array[$i]</td>
	<td>$NCHN_calls_array[$i]</td>
	<td>$WIP_calls_array[$i]</td>
	...
	//for($j = 0; $j < count($our_array); $j++) {
	if ($show_percentages) {
		//$CSV_lines.=preg_replace('/\s/', '', "\"$SuserRAW\",\"$Suser_group\",\"$Slast_user_group$BBD_csv_filler\",\"$Scalls\",\"$pfUSERtime_MS\",\"$pfUSERtotPAUSE_MS\",\"$pfUSERtotPAUSE_MS_pct\",\"$pfUSERavgPAUSE_MS\",\"$pfUSERtotWAIT_MS\",\"$pfUSERtotWAIT_MS_pct\",\"$pfUSERavgWAIT_MS\",\"$pfUSERtotTALK_MS\",\"$pfUSERtotTALK_MS_pct\",\"$pfUSERavgTALK_MS\",\"$pfUSERtotDISPO_MS\",\"$pfUSERtotDISPO_MS_pct\",\"$pfUSERavgDISPO_MS\",\"$pfUSERtotDEAD_MS\",\"$pfUSERtotDEAD_MS_pct\",\"$pfUSERavgDEAD_MS\",\"$pfUSERtotCUSTOMER_MS\",\"$pfUSERtotCUSTOMER_MS_pct\",\"$pfUSERavgCUSTOMER_MS\",\"$total_break_time\",\"$lgd_time\",\"$md_time\",\"$login_time\",\"$lb_time\"$CSVstatuses");
	} 
	else 
	{
	//$CSV_lines.=preg_replace('/\s/', '', "\"$our_array[$i]\",\"$SuserRAW\",\"$our_array_time[$i]\",\"$our_logout[$i]\",\"$our_logout_time[$i]\",\"$total_calls[$i]\",\"$total_time[$i]\",\"$pt_time_array[$i]\",\"$pt_avg[$i]\",\"$wt_time_array[$i]\",\"$wait_avg[$i]\",\"$talk_time_array[$i]\",\"$talk_avg[$i]\",\"$dispo_time_array[$i]\",\"$disp_avg[$i]\",\"$dead_time_array[$i]\",\"$dead_avg[$i]\",\"$customer_time[$i]\",\"$customer_avgtime[$i]\",\"$total_break_time[$i]\",\"$lgd_time_array[$i]\",\"$md_time_array[$i]\",\"$login_time_array[$i]\",\"$lb_time_array[$i]\"$CSVstatuses");
	$CSV_lines.=preg_replace('/\s/', '',
    "\"$our_array[$i]\",
	\"Banglore\",
	\"$Sfull_name\",
	...
	\"$lgd_time_array[$i] \",
	\"$lg_time_array[$i]\",
	\"$our_array[$i] $our_array_time[$i]\",
	\"$md_time_array[$i]\",
	\"$connect_calls_array[$i]\",
	\"$notconnect_calls_array[$i]\",
	\"$out_calls_array[$i]\",
	\"$DNC_calls_array[$i]\",
	\"\",
	\"\",
...
if ($show_percentages) {
	...
	//$ASCII_text.="<tr><td colspan='8'>  "._QXZ("TOTALS",33)." "._QXZ("AGENTS",32,"r").":$TOT_AGENTS$BBD_filler </td><td> $overall_calls</td><td>$total_overall_time</td><td>$total_pt_time</td><td> $total_avg_pause </td><td>$total_wt_time</td><td> $total_avg </td><td>$total_talk_time</td><td> $total_avg_talk </td><td>$total_dispo_time</td><td> $total_avg_disp </td><td>$total_dead_time</td><td> $total_avg_dead </td><td>$total_customer_time</td><td>$total_avg_customer_time</td><td>$tot_total_break_time</td><td>$total_lgd_time</td><td>$total_md_time</td><td>$total_login_time</td><td>$total_lb_time</td><td>$SUMstatusesHTML</td></tr>";
	//$ASCII_text.="+-----------------+----------+----------------------+----------------------+".$BBD_header."--------+-----------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+----------+--------+$statusesHEAD\n";
...
if ($show_percentages) {
	...
	//$CSV_total=preg_replace('/\s/', '', "\"\",\"\",\"\",\"\",\"\",\"\",\""._QXZ("TOTALS")."\",\""._QXZ("AGENTS").":$TOT_AGENTS\",\"$overall_calls\",\"$total_overall_time\",\"$total_pt_time\",\"$total_avg_pause\",\"$total_wt_time\",\"$total_avg\",\"$total_talk_time\",\"$total_avg_talk\",\"$total_dispo_time\",\"$total_avg_disp\",\"$total_dead_time\",\"$total_avg_dead\",\"$total_customer_time\",\"$total_avg_customer_time\",\"$tot_total_break_time\",\"$total_lgd_time\",\"$total_md_time\",\"$total_login_time\",\"$total_lb_time\"$CSVSUMstatuses\n\n");
}
