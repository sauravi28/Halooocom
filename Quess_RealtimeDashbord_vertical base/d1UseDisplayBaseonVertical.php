		...
		<input type = "hidden" value = "" id = "d1UsersUnderD2ID">
          ...
          <div class="col-12 col-sm-6 col-md-2">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
			    ...
			    <span class="" style = "cursor:pointer " id = "D1User_<?php echo $n?>" onclick = "d1UsersUnderSuperAdmin('<?php echo $D1UsersUnderSuperAdmin[$n]; ?>','<?php echo $colorCode; ?>','<?php echo $n?>','<?php echo $D2_count; ?>');"><?php echo $D1UsersUnderSuperAdmin[$n]; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-2">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><b>D1</b></span> 
