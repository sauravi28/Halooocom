		...
		?>
          ...
          <div class="col-12 col-sm-6 col-md-2">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text" style = "cursor:pointer" onclick = "d1UsersVertical('<?php echo $D1Vertical_headname; ?>','<?php echo $color[$n]; ?>','<?php echo $n?>');"><b><?php echo $VerticalNameVal[$n];?></b></span> 
			  </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
function d1UsersVertical(d1userVal,colorCodepar,numberVal,d1VertivalName){
	...
	var loginUserD1 = '<?php echo $D1UserLoggedIn; ?>';
	 ...
	 const xhttp = new XMLHttpRequest();
	  ...
	  xhttp.open("GET", "ajax/d1UseDisplayBaseonVertical.php?BaseonverticalD1Val="+BaseonverticalD1Val+"&loginUserD1="+loginUserD1+"&colorCode="+colorCode+"&number="+numberVal, true);
	  xhttp.send();
...
function d1UsersUnderSuperAdmin(d1users,colorCodepar,number,D1_Count){   
	...
	var colorCode = colorCodepar;
	 ...
	 const xhttp = new XMLHttpRequest();
	  ...
	  xhttp.open("GET", "ajax/d1UserForDisplayForSuperAdmin.php?D1userUderSuperAdmin="+d1users+"&loginUserD1="+loginUserD1+"&colorCode="+colorCode, true);
	  xhttp.send();
...
function D2UsersUnderD1AndSuperAdmin(d2users,colorCodepar,id,D2_Count){    
	document.getElementById('d3UsersUnderD2ID').value = ''; 
	document.getElementById('d2UsersUnderD1ID').value  = '';
...
//	alert(D1UserName);
	var colorCode = colorCodepar;
	 ...
	 const xhttp = new XMLHttpRequest();
	  ...
	  xhttp.open("GET", "ajax/d2UserForDisplayForSuperAdmin.php?D2userUderSuperAdmin="+d2users+"&loginUserD1="+D1UserName+"&colorCode="+colorCode, true);
	  xhttp.send();
