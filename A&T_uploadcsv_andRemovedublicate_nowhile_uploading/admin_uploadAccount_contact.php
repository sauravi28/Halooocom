...
<title><?php echo _QXZ("ADMINISTRATION: DND PhoneBook"); ?></title>
</head>
...
echo "<section style='margin-top:-40px;' class='content-header'>          <h1 style='font-size:23px; color:#4a4a4a;'>            "._QXZ("UPLOAD ACCOUNT AND CONTACT DETAILS")."          </h1>       </section>";
...
?>
</form><?php // Get status messageif(!empty($_GET['status'])){    switch($_GET['status']){        case 'succ':            $statusType = 'alert-success';            $statusMsg = 'Data has been imported successfully.';			echo "<font style='font-size:15px;color:#36457E;font-weight:700;'><a href='generate_xlsxFile.php?download=1'>[<u>Download File</u>]</a></font>";					 	            break;        case 'err':            $statusType = 'alert-danger';            $statusMsg = 'Some problem occurred, please try again.';            break;        case 'invalid_file':            $statusType = 'alert-danger';            $statusMsg = 'Please upload a valid CSV file.';            break;        default:            $statusType = '';            $statusMsg = '';    }}?><!-- Display status message --><?php if(!empty($statusMsg)){ ?><div class="col-xs-12">    <div class="alert <?php echo $statusType; ?>"><?php echo $statusMsg; ?></div></div><?php } ?><div class="row">    <!-- Import link -->        <!-- CSV file upload form -->    <div class="col-md-12" id="importFrm">        <form action="importAccountDetails.php" method="post" enctype="multipart/form-data">		   <div class="col-md-12 head">				<div class="float-right">					<label for="Upload leads">1)Upload Account Details File:</label>&nbsp;&nbsp;&nbsp;&nbsp;				</div>          </div>            <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="file" /><br><br>			<div class="col-md-12 head">				<div class="float-right">					<label for="Upload leads">2)Upload Contact Details File:</label>&nbsp;&nbsp;&nbsp;&nbsp;				</div>            </div>			<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="file_contactdetails" /><br><br>						<input type="submit" class="btn" name="importSubmit" value="Submit" style="position: relative;top: -27px;left: 280px;background-color: #36457E !important;color: #FFFF;">        </form>    </div></div><!-- Show/hide CSV upload form --><script>function formToggle(ID){    var element = document.getElementById(ID);    if(element.style.display === "none"){        element.style.display = "block";    }else{        element.style.display = "none";    }}</script>
</html>
