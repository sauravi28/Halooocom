            ...
            while(($line = fgetcsv($csvFile1)) !== FALSE){
				...
				$AllocationType = $line[15];
				   ...
				   // Insert member data in the database
					$sql_insert = 'insert into vicidial_Accountdetails (accno,final_city,state,zone,name,pos,emi_amt,total_overdue,last_payment_amount,last_payment_date,due,m0,m1,m2,m3,allocationtype,entry_date_time) 
					values("'.$ACCNO.'","'.$FINAL_CITY.'","'.$STATE.'","'.$ZONE.'","'.$NAME.'","'.$POS.'","'.$EMI_AMT.'","'.$TOTAL_OVERDUE.'","'.$LAST_PAYMENT_AMOUNT.'","'.$LAST_PAYMENT_DATE.'","'.$Due.'","'.$M0.'","'.$M1.'","'.$M2.'","'.$M3.'","'.$AllocationType.'","'.$entry_date_time.'")'; 
				   // echo $sql_insert;
					//die;
