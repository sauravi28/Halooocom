...
$db = mysqli_connect($hostname, $user1, $password,$mysql_database);
	...
	<b><font size="3">Select Date </font> </b> &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; 
	 ...
	 <b><font size="3">Select User</font> </b>&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<select id="txt_user" name = "txt_user" style="height: 28px;">
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php if($download == 'ok'){?><a href='<?php echo "backup_$user.tgz"?> '  target="_self">Click to Download</a> <?php } ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
