		...
		?>
          ...
          <div class="col-12 col-sm-6 col-md-2">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="" style = "cursor:pointer" id = "D1UserVertical_<?php echo $n?>"  onclick = "d1UsersVertical('<?php echo $D1Vertical_headname; ?>','<?php echo $color[$n]; ?>','<?php echo $n;?>','<?php echo $D1Vertical_Name; ?>');"><b><?php echo $VerticalNameVal[$n];?></b></span> 
			  </div>
...
function d1UsersVertical(d1userVal,colorCodepar,numberVal,d1VertivalName){
	...
	var D1Vertical_Count = "<?=$D1Vertical_Count;?>";
	
	for(let i = 0; i < D1Vertical_Count ; i++ ){
		if(numberVal == i){
			document.getElementById('D1UserVertical_'+numberVal).style.color = '#e65c00';
			document.getElementById('D1UserVertical_'+numberVal).style.fontWeight = "1000";
		}else{
			document.getElementById('D1UserVertical_'+i).style.color = 'black';
			document.getElementById('D1UserVertical_'+i).style.fontWeight = "400";
		}
	}
