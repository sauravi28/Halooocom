...
$url ="http://192.168.0.100/admin/AST_agent_performance_detail_mail.php?DB=&query_date=$date&end_date=$date&group%5B%5D=--ALL--&user_group%5B%5D=ADMIN&users%5B%5D=--ALL--&shift=ALL&SUBMIT=SUBMIT";
