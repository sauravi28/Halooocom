...
$file_yest = "LeadReport_".$date_yest.".csv";
$date = date('Y-m-d');
$file1 = "LeadReport_".$date.".csv";
...
if ($run_export > 0)
   ...
   //step8 
		$sel_cam  = "select campaign_id from vicidial_campaigns";
$rslt_cam =  mysql_to_mysqli($sel_cam,$link);
while($row_cam = mysqli_fetch_array($rslt_cam)) 
{
$camp .= "'$row_cam[0]',";
}
$camp = rtrim($camp,',');
$campaign_SQL = "and vl.campaign_id in($camp)";


$sel_cam1  = "select group_id from vicidial_inbound_groups";
$rslt_cam1 = mysql_to_mysqli($sel_cam1, $link);
while($row_cam1 = mysqli_fetch_array($rslt_cam1))
{
$grp .= "'$row_cam1[0]',";
}
$grp = rtrim($grp,',');
$group_SQL = "and vl.campaign_id in($grp)";
...
;
	...
	if ( ($outbound_to_print > 0) or ($inbound_to_print > 0) )
		...
		//step2 
			...
			$header = "call_date,duration,phone_dialed_no,status,user,full_name,campaign_id,$rowl[11],source_id,list_id,gmt_offset_now,$rowl[14],$rowl[13],$rowl[0],$rowl[1],$rowl[2],$rowl[3],$rowl[4],$rowl[5],$rowl[6],$rowl[7],$rowl[8],$rowl[9],$rowl[10],$rowl[11],gender,date_of_birth,$rowl[15],$rowl[16],$rowl[17],comments,$rowl[19],$rowl[20],$rowl[21],$rowl[22],$rowl[23],$rowl[24],$rowl[25],$rowl[26],$rowl[27],$rowl[28],$rowl[29],$rowl[30],$rowl[31],$rowl[32],$rowl[33],$rowl[34],$rowl[35],$rowl[36],$rowl[37],$rowl[38],$rowl[39],$rowl[40],$rowl[41],$rowl[42],$rowl[43],$rowl[44],$rowl[45],$rowl[46],$rowl[47],$rowl[48],$rowl[49],$rowl[50],$rowl[51],$rowl[52],$rowl[53],$rowl[54],$rowl[55],$rowl[56],$rowl[57],$rowl[58],user_group,alt_dial,rank,owner,lead_id$EFheader,list_name,list_description,status_name$RFheader$EXheader$NFheader$CFheader\r\n";
 ...
 $length = count($export_duplicate_check_line);
  ...
  //echo "*".$export_duplicate_check_line[$m];echo "<br/>";
			...
			fwrite($handle,$RAW_EXPORT[$current_line_number]);
