		...
		echo "File==".$file;
			...
			$link = mysqli_connect("localhost","root","Hal0o(0m@72427242","asterisk");
				 ...
				 // Dispo//
           	    ...
           	    $sql = "insert into voicefiles(date,time,source,destination,duration,filename,campaign,disposition,call_type,call_mode)values('$date_cal','$time','$source','$destination','$duration','$filename1','$campaign','$Disposition','$call_type','$call_mode')";
