...
<link rel="stylesheet" href="offlineJsFiles/font-awesome.min.css">
	...
	tfoot input {
	  ...
	  <!--<link href="offlineJsFiles/datatables.min.css" rel="stylesheet">-->
	  <link href="offlineJsFiles/dataTables.checkboxes.css" rel="stylesheet">
	</style>
	<style>
	.btn {
...
.dt-button-collection {
    ...
    <script src="assets/js/main.js"></script>
	  ...
	  <!--<script src="offlineJsFiles/jquery-3.3.1.js"></script>
	  <script src="offlineJsFiles/jquery.dataTables.min.js"></script>
	  
	  
	  
	   <script src="offlineJsFiles/jquery.min.js"></script>
	   <script src="offlineJsFiles/datatables.min.js"></script>
       <script src="offlineJsFiles/dataTables.checkboxes.min.js"></script>-->
		   
	<script src = "offlineJsFiles/jquery-3.5.1.js"></script>
	<script src = "offlineJsFiles/jquery.dataTables.min.js"></script>
	<script src = "offlineJsFiles/dataTables.buttons.min.js"></script>
	<script src = "offlineJsFiles/jszip.min.js"></script>
	<script src = "offlineJsFiles/pdfmake.min.js"></script>
	<script src = "offlineJsFiles/vfs_fonts.js"></script>
	<script src = "offlineJsFiles/buttons.html5.min.js"></script>
		
	<link rel = "stylesheet" href = "offlineJsFiles/jquery.dataTables.min.css">
	<link rel="stylesheet" href="offlineJsFiles/font-awesome.min.css">
...
<div class="test" align="left" style="margin-left:50px;margin-bottom:20px">
	<form name="form1" method="post" action="<?php echo($_SERVER['PHP_SELF'])?>?user=<?php echo $user;?>">
        <tbody><tr>
