                ...
                <div class="row">
					<table align="center">  
						<form name="form1" method="post" action="archive.php">  
							<tbody>
							    <tr><td style="text-decoration: underline;"> Download Voicefiles :- </td></tr>
								<tr><td></td></tr>
								<tr><td></td></tr>
								<tr>
									...
									<td style="width: 50%;">Select Extension:&nbsp;&nbsp;<select id="txt_extension" name = "txt_extension" style="height: 28px;">
									<option value ="<?php echo $txt_extension; ?>" selected><?php echo $txt_extension; ?></option>
									<?php 
									$query = "SELECT DISTINCT(`extension`) FROM `cdr`";
									//echo $query;
