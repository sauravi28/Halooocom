...
?>
 ...
 <?php if($sla_expiry !='' && $sla_expiry != '0000-00-00' ){ ?>
	    <marquee bgcolor='#1A2B6D' font style='bold;position:absolute;z-index:1030;' scrolldealy: default(85);><font size='5' face='auto'><font color='#D8BFD8'><?php if($date_def[0] ==$today || $date_def[1] ==$today || $date_def[2] ==$today || $date_def[3] ==$today || $date_def[4] ==$today || $date_def[5] ==$today){ echo "Note: Please clear the due amount for uninterrupted service..";} ?></marquee> <br>
	<?php } ?>  
	
	
	
	<TABLE class="table " CELLPADDING=0 CELLSPACING=0 width=100% style="background: #a5d26b;margin-top: 8px;"><TR>
	<TD style="width: 200px;background-color: white;padding: 1px 3px 2px 10px;"><A HREF="./admin.php">
	<span class="logo-lg">
	<img style="width: 160px; height: 50px;padding-left: 19px;" src="logo1.png" ALT="System logo">
	</span>
	</A> &nbsp; </TD>
	
	<?php if($sla_expiry !='' && $sla_expiry != '0000-00-00'){ ?>
	     <span style="color:#1A2B6D;font-size:20px;font-weight:600;display: inline-block;position: absolute;top: 92px;right: 10px;"><?php if($date_def[0] ==$today || $date_def[1] ==$today || $date_def[2] ==$today || $date_def[3] ==$today || $date_def[4] ==$today || $date_def[5] ==$today){ echo "<a href='https://www.instamojo.com/@haloocom/' target='_blank' style='color:#1A2B6D;text-decoration: underline;'>Payment</a>";} ?></span>
	<?php } ?>  
	...
	if ( ($reports_only_user < 1) and ($qc_only_user < 1) )
		{
	?>
	<TD class="head"> &nbsp; <A HREF="admin.php?ADD=999998" ALT="Users"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Users"); ?></B></FONT></A> &nbsp; </TD>
	<TD class="head"> &nbsp; <A HREF="admin.php?ADD=10" ALT="Campaigns"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Campaigns"); ?></B></FONT></A> &nbsp; </TD>
	<?php
	if (($SSqc_features_active=='1') && ($qc_auth=='1')) 
		{
		?>
		<TD class="head"> &nbsp; <A HREF="admin.php?ADD=100000000000000" ALT="Quality Control"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Quality Control"); ?></B></FONT></A> &nbsp; </TD>
		<?php
		}
	?>
	<TD class="head"> &nbsp; <A HREF="admin.php?ADD=100" ALT="Lists"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Lists"); ?></B></FONT></A> &nbsp; </TD>
	<TD class="head"> &nbsp; <A HREF="admin.php?ADD=1000000" ALT="Scripts"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Scripts"); ?></B></FONT></A> &nbsp; </TD>
	<!--<TD > &nbsp; <A HREF="admin.php?ADD=10000000" ALT="Filters"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Filters"); ?></B></FONT></A> &nbsp; </TD>
	<TD>  &nbsp; <A HREF="admin.php?ADD=1000" ALT="Inbound"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Inbound"); ?></B></FONT></A> &nbsp; </TD>
	<TD > &nbsp; <A HREF="admin.php?ADD=100000" ALT="User Groups"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("User Groups"); ?></B></FONT></A> &nbsp; </TD>
	<TD > &nbsp; <A HREF="admin.php?ADD=10000" ALT="Remote Agents"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Remote Agents"); ?></B></FONT></A> &nbsp; </TD>-->
	<TD class="head"> &nbsp; <A HREF="admin.php?ADD=0A" ALT="Admin"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Admin"); ?></B></FONT></A> &nbsp; </TD>
	<TD class="head"> &nbsp; <A HREF="admin.php?ADD=999999" ALT="Reports"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Reports"); ?></B></FONT></A> &nbsp; </TD>
	<TD class="head"> &nbsp; <A HREF="admin.php?ADD=10#" ALT="Reports"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Miscellaneous"); ?></B></FONT></A> &nbsp; </TD>
	<?php 
		} 
	else 
		{ 
		...
		if ($reports_only_user > 0)
			{
			?>
			<TD> &nbsp; <A HREF="admin.php?ADD=999999" ALT="Reports"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Reports"); ?></B></A> &nbsp; </TD>
			<?php
			}
		else
			{
			if (($SSqc_features_active=='1') && ($qc_auth=='1')) 
				{
				?>
				<TD> &nbsp; <A HREF="admin.php?ADD=100000000000000" ALT="Quality Control"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=3><B><?php echo _QXZ("Quality Control"); ?></B></FONT></A> &nbsp; </TD>
				<?php
				}
			}
		}
...
if ( ($ADD==3511) or ($ADD==35112) or ($ADD==2511) or ($ADD==25112) or ($ADD==2611) or ($ADD==4511) or ($ADD==45112) or ($ADD==5511) or ($ADD==3111) or ($ADD==2111) or ($ADD==2011) or ($ADD==4111) or ($ADD==5111) )
	{
...
if ( ($ADD==3511)or ($ADD==35112) or ($ADD==2511) or ($ADD==25112) or ($ADD==2611) or ($ADD==4511) or ($ADD==45112) or ($ADD==5511) )
	{
...
<TABLE BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0 WIDTH=100% HEIGHT=15 style="margin-top:36px;">
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=10"><span><?php echo _QXZ("Show Campaigns"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=11"><span><?php echo _QXZ("Add A New Campaign"); ?></span></a></li>
   <li><a href="<?php echo $ADMIN ?>?ADD=12"><span><?php echo _QXZ("Copy Campaign"); ?></span></a><?php } ?></li>
   <li class='last'><a href="./AST_timeonVDADallSUMMARY.php"><span><?php echo _QXZ("Real-Time Campaigns Summary"); ?></span></a></li>
</ul>
</div>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=100000000"><span><?php echo _QXZ("Show Call Times"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=111111111"><span><?php echo _QXZ("Add A New Call Time"); ?></span></a>
<?php } ?> 
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=1000000000"><span><?php echo _QXZ("Show State Call Times"); ?></span></a><?php if ($add_copy_disabled < 1) { ?></li>
   <li><a href="<?php echo $ADMIN ?>?ADD=1111111111"><span><?php echo _QXZ("Add A New State Call Time"); ?></span></a>
<?php } ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=1200000000"><span><?php echo _QXZ("Holidays"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=1211111111"><span><?php echo _QXZ("Add Holiday"); ?></span></a>
<?php } ?>
</li>
</ul>
</div>
 ...
 <a href="<?php echo $ADMIN ?>?ADD=111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add A New Call Time"); ?> </a> &nbsp;|<?php } ?> 


<a href="<?php echo $ADMIN ?>?ADD=1000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Show State Call Times"); ?> </a> &nbsp;|<?php if ($add_copy_disabled < 1) { ?> 

<a href="<?php echo $ADMIN ?>?ADD=1111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add A New State Call Time"); ?> </a> &nbsp;|<?php } ?> 

<a href="<?php echo $ADMIN ?>?ADD=1200000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Holidays"); ?> </a> &nbsp;|<?php if ($add_copy_disabled < 1) { ?> <a href="<?php echo $ADMIN ?>?ADD=1211111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add Holiday"); ?> </a><?php } ?></TD></TR>-->
		<?php } 
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=130000000"><span><?php echo _QXZ("Show Shifts"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=131111111"><span><?php echo _QXZ("Add A New Shift"); ?></span></a><?php } ?></li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=10000000000"><span><?php echo _QXZ("Show Phones"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=11111111111"><span><?php echo _QXZ("Add A New Phone"); ?></span></a>
<?php } ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=12000000000"><span><?php echo _QXZ("Phone Alias List"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=12111111111"><span><?php echo _QXZ("Add A New Phone Alias"); ?></span></a>
<?php } ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=13000000000"><span><?php echo _QXZ("Group Alias List"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=13111111111"><span><?php echo _QXZ("Add A New Group Alias"); ?></span></a>
<?php } ?>
</li>
</ul>
</div>
...
<!--<TR BGCOLOR=<?php echo $phones_color ?>><TD ALIGN=LEFT COLSPAN=2> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=10000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Show Phones"); ?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;

<a href="<?php echo $ADMIN ?>?ADD=11111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add A New Phone"); ?> </a>&nbsp;|<?php } ?>&nbsp;

<a href="<?php echo $ADMIN ?>?ADD=12000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Phone Alias List"); ?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>

&nbsp;<a href="<?php echo $ADMIN ?>?ADD=12111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add A New Phone Alias"); ?> </a>&nbsp;|<?php } ?>&nbsp;

<a href="<?php echo $ADMIN ?>?ADD=13000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Group Alias List"); ?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;

<a href="<?php echo $ADMIN ?>?ADD=13111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add A New Group Alias"); ?> </a><?php } ?></TD></TR>-->
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=1000000000000"><span><?php echo _QXZ("Show Conferences"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=1111111111111"><span><?php echo _QXZ("Add A New Conference"); ?></span></a>
<?php } ?> 
</li>
    <li><a href="<?php echo $ADMIN ?>?ADD=10000000000000"><span><?php echo _QXZ("Show Haloocom Conferences"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=11111111111111"><span><?php echo _QXZ("Add A New Haloocom Conference"); ?></span></a>
<?php } ?>
</li>
</ul>
</div>

<!--<TR BGCOLOR=<?php echo $conference_color ?>><TD ALIGN=LEFT COLSPAN=2> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1000000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Show Conferences"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add A New Conference"); ?> </a> &nbsp; |<?php } ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=10000000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Show Haloocom Conferences"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=11111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo _QXZ("Add A New Haloocom Conference"); ?> </a><?php } ?></TD></TR>-->
		<?php }
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=100000000000"><span><?php echo _QXZ("Show Servers"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=111111111111"><span><?php echo _QXZ("Add A New Server"); ?></span></a>
<?php } ?>
</li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=130000000000"><span><?php echo _QXZ("Show Templates"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=131111111111"><span><?php echo _QXZ("Add A New Template"); ?></span></a>
<?php } ?>
</li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=140000000000"><span><?php echo _QXZ("Show Carriers"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=141111111111"><span><?php echo _QXZ("Add A New Carrier"); ?></span></a>
</li>
    <li><a href="<?php echo $ADMIN ?>?ADD=140111111111"><span><?php echo _QXZ("Copy A Carrier"); ?></span></a>
<?php } ?>
</li>
</ul>
</div>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=170000000000"><span><?php echo _QXZ("Show Voicemail Entries"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=171111111111"><span><?php echo _QXZ("Add A New Voicemail Entry"); ?></span></a>
<?php } ?>
</li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=311111111111111"><span><?php echo _QXZ("System Settings"); ?></span></a>
</li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=180000000000"><span><?php echo _QXZ("Screen Labels"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
  <li><a href="<?php echo $ADMIN ?>?ADD=181111111111"><span><?php echo _QXZ("Add A Screen Label"); ?></span></a>
<?php } ?>
</li>
</ul>
</div>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=190000000000"><span><?php echo _QXZ("Contacts"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=191111111111"><span><?php echo _QXZ("Add A Contact"); ?></span></a>
<?php } ?>
</li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=192000000000"><span><?php echo _QXZ("Settings Containers"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=192111111111"><span><?php echo _QXZ("Add A Settings Container"); ?></span></a>
<?php } ?>
</li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=193000000000"><span><?php echo _QXZ("Status Groups"); ?></span></a>
<?php if ($add_copy_disabled < 1) { ?>
</li>
   <li><a href="<?php echo $ADMIN ?>?ADD=193111111111"><span><?php echo _QXZ("Add A Status Group"); ?></span></a>
<?php } ?>
</li>
...
<div id='cssmenu'>
<ul>
   <li><a href="<?php echo $ADMIN ?>?ADD=321111111111111"><span><?php echo _QXZ("System Statuses"); ?></span></a></li>
   <li><a href="<?php echo $ADMIN ?>?ADD=331111111111111"><span><?php echo _QXZ("Status Categories"); ?></span></a></li>
   <li><a href="<?php echo $ADMIN ?>?ADD=341111111111111"><span><?php echo _QXZ("QC Status Codes"); ?></span></a></li>
...
<div id='cssmenu'>
<ul>
   <li><a href="./user_stats.php?user=<?php echo $user ?>"><span><?php echo _QXZ("User Stats"); ?> </span></a></li>
   <li><a href="./user_status.php?user=<?php echo $user ?>"><span><?php echo _QXZ("User Status"); ?></span></a></li>
   <li><a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>"><span><?php echo _QXZ("Time Sheet"); ?> </span></a></li>
   <li class='last'><a href="./AST_agent_days_detail.php?user=<?php echo $user ?>"><span><?php echo _QXZ("Days Status"); ?></span></a></li>
</ul>
</div>

	<!--<TR class="box box-default"><TD ALIGN=LEFT COLSPAN=2 class="box-header with-border"> &nbsp; <a href="./user_stats.php?user=<?php echo $user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>><?php echo _QXZ("User Stats"); ?> </a> &nbsp; | &nbsp; <a href="./user_status.php?user=<?php echo $user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>><?php echo _QXZ("User Status"); ?> </a> &nbsp; | &nbsp; <a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>><?php echo _QXZ("Time Sheet"); ?> </a> &nbsp; | &nbsp; <a href="./AST_agent_days_detail.php?user=<?php echo $user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>><?php echo _QXZ("Days Status"); ?> </a></TD></TR>-->
...
<!-- start if submenu then remove underline -->



<?php
if ( ($ADD=='3') or ($ADD=='3') or ($ADD=='10') or ($ADD=='11') or ($ADD==12) or ($ADD==31) or ($ADD==81) or ($ADD==51) or ($ADD==6) or ($ADD==21) or ($ADD==41) or ($ADD==61) or ($ADD==52) or ($ADD==53) or ($ADD==62) or ($ADD==63) or ($ADD==34) or ($ADD==49) or ($ADD==311) or ($ADD==121) or ($ADD==100000000) or ($ADD==1000000000) or ($ADD==1200000000) or ($ADD==111111111) or ($ADD==1111111111) or ($ADD==1211111111) or ($ADD==130000000) or ($ADD==131111111) or ($ADD==10000000000) or ($ADD==12000000000) or ($ADD==13000000000) or ($ADD==11111111111) or ($ADD==12111111111) or ($ADD==13111111111) or ($ADD==130000000000) or ($ADD==131111111111) or ($ADD==140000000000) or ($ADD==141111111111) or ($ADD==140111111111) or ($ADD==100000000000) or ($ADD==111111111111) or ($ADD==1000000000000) or ($ADD==10000000000000) or ($ADD==1111111111111) or ($ADD==11111111111111) or ($ADD==311111111111111) or ($ADD==180000000000) or ($ADD==181111111111) or ($ADD==321111111111111) or ($ADD==331111111111111) or ($ADD==341111111111111) or ($ADD==193000000000) or ($ADD==193111111111) or ($ADD==170000000000) or ($ADD==171111111111) or ($ADD==192000000000) or ($ADD==192111111111) or ($ADD==190000000000) or ($ADD==311111111) or ($ADD==3111111111) or ($ADD==3211111111) or ($ADD==331111111) or ($ADD==31111111111) or ($ADD==32111111111) or ($ADD==33111111111) or ($ADD==331111111111) or ($ADD==341111111111) or ($ADD==3111111111111) or ($ADD==31111111111111) or ($ADD==381111111111) or ($ADD==393111111111) or ($ADD==371111111111) or ($ADD==392111111111) or ($ADD==311111111111) or ($ADD==999990) or ($ADD==999991) or ($ADD==211111111) or ($ADD==411111111)or ($ADD==511111111) or ($ADD==611111111) or ($ADD==2111111111) or ($ADD==4111111111) or ($ADD==5111111111) or ($ADD==6111111111) or ($ADD==2211111111) or ($ADD==4211111111) or ($ADD==5211111111) or ($ADD==6211111111) or ($ADD==231111111) or ($ADD==431111111) or ($ADD==531111111) or ($ADD==631111111) or ($ADD==21111111111) or ($ADD==22111111111) or ($ADD==23111111111) or ($ADD==41111111111) or ($ADD==42111111111) or ($ADD==43111111111) or ($ADD==51111111111) or ($ADD==52111111111) or ($ADD==53111111111) or ($ADD==61111111111) or ($ADD==62111111111) or ($ADD==63111111111) or ($ADD==231111111111) or ($ADD==431111111111) or ($ADD==531111111111) or ($ADD==631111111111) or ($ADD==241111111111) or ($ADD==240111111111) or ($ADD==441111111111) or ($ADD==541111111111) or ($ADD==641111111111) or ($ADD==211111111111) or ($ADD==411111111111) or ($ADD==511111111111) or ($ADD==611111111111) or ($ADD==2111111111111) or ($ADD==21111111111111) or ($ADD==4111111111111) or ($ADD==41111111111111) or ($ADD==5111111111111) or ($ADD==51111111111111) or ($ADD==6111111111111) or ($ADD==61111111111111) or ($ADD==411111111111111) or ($ADD==281111111111) or ($ADD==291111111111) or ($ADD==481111111111) or ($ADD==491111111111) or ($ADD==581111111111) or ($ADD==591111111111) or ($ADD==681111111111) or ($ADD==691111111111) or ($ADD==221111111111111) or ($ADD==231111111111111) or ($ADD==421111111111111) or ($ADD==431111111111111) or ($ADD==441111111111111) or ($ADD==293111111111) or ($ADD==492111111111) or ($ADD==493111111111) or ($ADD==593111111111) or ($ADD==592111111111) or ($ADD==692111111111) or ($ADD==693111111111) or ($ADD==251111111111) or ($ADD==261111111111) or ($ADD==271111111111) or ($ADD==451111111111) or ($ADD==461111111111) or ($ADD==471111111111) or ($ADD==551111111111) or ($ADD==561111111111) or ($ADD==571111111111) or ($ADD==671111111111) or ($ADD==661111111111) or ($ADD==651111111111) or ($ADD==292111111111) or ($ADD==492111111111) or ($ADD==592111111111) or ($ADD==692111111111)){ 
		?>
<TR><TD ALIGN=LEFT COLSPAN=2 HEIGHT=2 BGCOLOR=#ECF0F5></TD></TR>
<?php
}
else {
?>
...
<!-- end if submenu then remove underline -->
...
<TR><TD ALIGN=LEFT COLSPAN=2>
 ...
 <!--add::rimpal-->
<!--          
<script type="text/javascript" src="soundboard/js/jquery.js" ></script>
<script type="text/javascript" src='soundboard/js/jquery-1.7.2.min.js'></script>
<script type="text/javascript" src='soundboard/js/jquery-ui-1.8.21.custom.min.js'></script>
