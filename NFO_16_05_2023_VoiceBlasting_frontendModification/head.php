...
<!--		<HR>-->
		...
		<li><a href="<?php echo $ADMIN ?>?ADD=15002"><i class="fa fa-circle-o"></i><?php echo _QXZ("Show VoiceBlasting Menus"); ?></a></li>
		<li><a href="<?php echo $ADMIN ?>?ADD=15112"><i class="fa fa-circle-o"></i><?php echo _QXZ("Add New VoiceBlasting Menu"); ?></a></li>
