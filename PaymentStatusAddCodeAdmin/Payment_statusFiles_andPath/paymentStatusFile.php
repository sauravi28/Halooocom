...
if (isset($_POST["submit_1"])){
    ...
    $size = $_FILES['myfile']['size'];
        ...
        if (move_uploaded_file($file, $destination)) {
            $sql = "INSERT INTO vicidial_PaymentStatus_data(filename,size,entry_date_time,payment_status,pay_date,ammount,client_name) VALUES ('$filename','$size','$date','$payment_status','$pay_date','$ammount','$client_name')";
			...
			//echo "lastInsert_id ===>".$lastInsert_id;
			  ...
			  $mail->addAttachment("/srv/www/htdocs/uploadsPaymentStatus_files/".$filename);
...
<div class="row">
    ...
    <div class="col-sm-4"><img src="haloocom_connect4/images/Haloocom Official Logo.png" name="logo" alt="logo" width="200px" height="80px" border="0" style="margin-left:153px;" /></div>
    <div class="col-sm-4"><h3 align="center" style="color:#6eba01;margin-top:20px;">ADD PAYMENT STATUS<h3></div>
    <div class="col-sm-4"><img src="haloocom_connect4/images/logo2New.png" name="logo" alt="Live Call" width="150px" height="80px" border="0" style="margin-left:204px;"/></div>


</div>
<hr style="border:1px solid #6eba01;margin-left:100px;margin-right:100px">
<div class="col-md-12">
   <table cellpadding="0" cellspacing="0" bgcolor="#fff" style="width: 90%;">             	
	...
	<td style="width: 20%;">	
	&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<label for="fname">Client Name</label><i class='fa fa-asterisk' style='color:red;font-size: x-small;'></i>
    &nbsp; &nbsp;<input type="text" name="client_name" id="client_name" required>&nbsp; &nbsp; &nbsp; &nbsp;</td>
