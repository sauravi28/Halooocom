...
if($loggedInuserName == '' && $loggedInPassword == '' ){
	header('Location:/haloocomConnect5/pages/Agent/connect5Login/index.php');
		...
		if($_POST['addtemplate']){
		   ...
		   $subject = $_POST['subject'];
			...
			$stmt_rs="SELECT template_id from email_template where template_id='$template_id';";
					...
					$stmt_insert="INSERT INTO email_template(created_date,template_id,template_body,campaign_id,subject) values('$date','$template_id','$template_body','$campaign_id','$subject')";
					$rslt_insert= mysqli_query($conn,$stmt_insert);
					       
							}else{
								echo "<script>alert('Template id already exist.');</script>";
							}
	}
	
	if($_POST['editTemplate'] == 'edit_Template'){  
			$txt_template_id = $_POST['txt_template_id'];
			$txt_template_body = $_POST['txt_template_body'];
			$txt_campaign_id = $_POST['txt_campaign_id'];
			$txt_subject = $_POST['txt_subject'];
			$txt_id = $_POST['txt_id'];
			
		 $stmt_update = "update email_template set template_id='$txt_template_id',template_body='$txt_template_body',campaign_id='$txt_campaign_id',subject='$txt_subject' where id='$txt_id'";
		 //echo $stmt_update;
		 //die;
	...
	if($_POST['deleteTemplate'] == 'delete_Template'){	
		 ...
		 $stmt_delete = "delete from email_template where id='$deleteTemplateID'";
    ...
    <section class="content">
      <div class="container-fluid">
		  ...
		  <?php if($loggedInUserLevel =="SuperAdmin"){?>
			<button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD EMAIL TEMPLATE</button>
			<?php } ?>
		   </div>
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">EMAIL TEMPLATE LISTINGS</h3>
          ...
          <div class="card-body">
            ...
            <div class="row">
             ...
             <table class="table table-striped projects table-bordered" id="table_camp">
              ...
              <tbody>
			  <?php 
			 $stmt_select="SELECT * from email_template";
	                  $rslt_rs= mysqli_query($conn,$stmt_select);
			  ...
			  ?>
                  <tr>
                      ...
                      <td class="project-actions text-right">
					    ...
					    <span class="btn btn-danger btn-sm"  onclick = "document.getElementById('myModal_delete').style.display='block'; templateDeleteFun('<?php echo $row["id"]; ?>','<?php echo $row["template_id"]; ?>')">
             ...
             <form action = "<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="CampaignID">Template ID<span style="color:red;">*</span></label>
                    <input type="text" class="form-control" id="txt_template_id" name="txt_template_id" pattern="^[a-zA-Z0-9\s]*$" placeholder="Enter Template ID" readonly>
                  </div>
				  <div class="form-group">
                    <label for="PhoneID">Subject<span style="color:red;">*</span></label> 
                    <input type="text" class="form-control" id="txt_subject" name="txt_subject" placeholder="Enter subject" required>
                  </div>
				  <div class="form-group">
                    <label for="PhoneID">Template Body<span style="color:red;">*</span></label>
					<textarea  class="form-control" id="txt_template_body" name="txt_template_body" rows="4" cols="50" pattern="^[a-zA-Z0-9\s]*$" required></textarea>
                  </div>
				  <div class="form-group">
                    <label for="CampaignName">Campaign <span style="color:red;">*</span></label>
                    <select class="form-control select2" style="width: 100%;" id="txt_campaign_id" name = "txt_campaign_id" required>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form action = "<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="PhoneID">Template ID<span style="color:red;">*</span></label> 
                    <input type="text" class="form-control" id="template_id" name="template_id" pattern="^[a-zA-Z0-9\s]*$" placeholder="Enter Template ID" required>
                  </div>
				  <div class="form-group">
                    <label for="PhoneID">Subject<span style="color:red;">*</span></label> 
                    <input type="text" class="form-control" id="subject" name="subject" pattern="^[a-zA-Z0-9\s]*$" placeholder="Enter subject" required>
                  </div>
				   <div class="form-group">
                    <label for="PhoneID">Template Body<span style="color:red;">*</span></label>  
                   <textarea  class="form-control" id="template_body" name="template_body" rows="4" cols="50" pattern="^[a-zA-Z0-9\s]*$" required></textarea>
                  </div>
				   <div class="form-group">
                    <label for="CampaignName">Campaign <span style="color:red;">*</span></label>
                    <select class="form-control select2" style="width: 100%;" id="campaign_id" name = "campaign_id" required>
					 <option value="">--Select--</option>
					<?php
                       $stmt_select1="SELECT campaign_id,campaign_name from campaign";
	                   $rslt_rs1= mysqli_query($conn,$stmt_select1);
  ...
  <div class="modal fade" id="myModal_delete" style="opacity: 3;top : 104px !important">
    <div class="modal-dialog">
      <div class="modal-content" style="top:40px;">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">DELETE EMAIL TEMPLATE</h4>
        ...
        <div class="modal-body">
         <form action = "" method = "POST">
                <div class="card-body">
                  <div class="form-group">
						<label for="UserID">Email Template ID</label>
   ...
   function templateEditFun(val)
	{
		...
		//alert(res);
			document.getElementById('txt_template_id').value=res[0];
			document.getElementById('txt_template_body').value=res[1];
			document.getElementById('txt_id').value=res[2];
			document.getElementById('txt_campaign_id').value=res[3];
			document.getElementById('txt_subject').value=res[4];
		    }
        }; 
		xhttp.open("GET", "/haloocomConnect5/pages/Agent_mongodb/ajax/get_emailTemplateedit_data.php?id="+val, true);
		xhttp.send();	  
		// Get the modal
