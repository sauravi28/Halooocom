...
$shutdown_script = "/srv/www/htdocs/admin/server_reboot_stop/new_shutdown_script.sh";
...
$logFilePath = "/srv/www/htdocs/admin/server_reboot_stop/script_execution_shutdown.log";
...
if (strpos($shutdown_output, "error") !== false) {
