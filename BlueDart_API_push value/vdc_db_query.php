...
// 1. To get access token and instance URL

/*$client_id = "3MVG9pcaEGrGRoTJzed0HLQAyD2O3xOUFp8.IKp1R7CYOlYj8bFfVUKFMMO7xKlS7SR8_ZALK_Q_P7.2pUVNW";
$client_secret = "08DBF3E69120350C4BA13ADEAAA8E1EA1D6EA27175491D659175DC55F1469800";
$username = "haloocom.api@dev.com";
$password = "haloocom@001";
$securityToken = "AHSEzE8XIieHgtJoRgTkyxq0";*/

$client_id = "3MVG9aWdXtdHRrI2vp0a6LEh0_LEL8mXZxKggSxAve32EGJr.fzOys_b8qOFOLVhWGqABaxg.DHmhpO3IvVIR";
$client_secret = "90AAFB52267CD354C9C2C8A00C195AB01D3FD98BC3F42BBFFD2010EC599C7915";
$username = "haloocom.api@uat.com";
$password = "haloocom@001";
$securityToken = "UxJcE8SywX4vcBe34z6WIUEWR";
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://test.salesforce.com/services/oauth2/token?grant_type=password&client_id='.$client_id.'&client_secret='.$client_secret.'&username='.$username.'&password='.$password.$securityToken.'',
  ...
  CURLOPT_HTTPHEADER => array(
    'Cookie: BrowserId=P4S_L5JwEe2BXssUHHwOjQ; CookieConsentPolicy=0:0; LSKey-c$CookieConsentPolicy=0:0'
  ),
));
...
$blue_stmt = "SELECT first_name,last_name,address1,address2,address3,field2,field3,field4,field5,field7,field8,field9,comments from vicidial_list where phone_number='$phone_number';";
$blue_rslt = mysql_to_mysqli($blue_stmt, $link);
$blue_count = mysqli_num_rows($blue_rslt);
if($blue_count>0)
{
	$blue_row = mysqli_fetch_row($blue_rslt);
	$salutation = $blue_row[0];
	$first_name = $blue_row[1];
	$last_name = $blue_row[2];
	$company = $blue_row[3];
	$pin_code = $blue_row[4];
	$Country = $blue_row[5]; 
	$State = $blue_row[6]; 
	$City = $blue_row[7]; 
	$Region__c = $blue_row[8]; 
	$Building_Name__c = $blue_row[9]; 
	$Area__c = $blue_row[10];
	$Email = $blue_row[11];
	$comments = $blue_row[12];
...
$data = array(
		...
		'City' => $City ,
		'Region__c' => $Region__c,
		'Building_Name__c' => $Building_Name__c,
		'Area__c' => $Area__c,
		'Email' => $Email
);
...
curl_setopt_array($curl, array(
  CURLOPT_URL => $instance_url.'/services/data/v57.0/sobjects/Lead',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    'Cookie: BrowserId=P4S_L5JwEe2BXssUHHwOjQ; CookieConsentPolicy=0:1; LSKey-c$CookieConsentPolicy=0:1'
  ),
));
...
curl_setopt_array($curl2, array(
  CURLOPT_URL => $instance_url.'/services/data/v57.0/sobjects/Task',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
