...
if($loggedInuserName == '' && $loggedInPassword == '' ){
	...
	if($_POST['allLevelData']){ 
			...
			if($D1Lebel != '' && $D4Lebel != "" && $D2Lebel == "" && $D3Lebel == ""){
							date_default_timezone_set('asia/kolkata');
							$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
							$bulk = new MongoDB\Driver\BulkWrite;
							$filter = [ 'd4_level' => "$D4Lebel" ,'d1_level' => "$D1Lebel"];							
			...
			}else if($D1Lebel == '' && $D4Lebel != "" && $D2Lebel != "" && $D3Lebel == ""){		
							$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
							$bulk = new MongoDB\Driver\BulkWrite;
							$filter = [ 'd4_level' => "$D4Lebel" ,'d2_level' => "$D2Lebel"];							
							$options = [  ];  //'sort' => ['created_date' => -1],'limit'=> 1
							$qry = new MongoDB\Driver\Query($filter,$options);
							$date = date("Y-m-d H:i:s");
							$rowsExtension = $mongo->executeQuery("admin.user_assign", $qry); 
							...
							$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
							$bulk = new MongoDB\Driver\BulkWrite;
							$filter = [ 'd4_level' => "$D4Lebel" ,'d3_level' => "$D3Lebel"];							
							$options = [  ];  //'sort' => ['created_date' => -1],'limit'=> 1
							$qry = new MongoDB\Driver\Query($filter,$options);
							$date = date("Y-m-d H:i:s");
							$rowsExtension = $mongo->executeQuery("admin.user_assign", $qry); 
							...
							$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
							$bulk = new MongoDB\Driver\BulkWrite;
							$filter = [ 'd4_level' => "$D4Lebel" ,'d1_level' => "$D1Lebel",'d2_level' => "$D2Lebel"];							
							$options = [  ];  //'sort' => ['created_date' => -1],'limit'=> 1
							$qry = new MongoDB\Driver\Query($filter,$options);
							$date = date("Y-m-d H:i:s");
							$rowsExtension = $mongo->executeQuery("admin.user_assign", $qry); 
							...
							$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
							$bulk = new MongoDB\Driver\BulkWrite;
							$filter = [ 'd4_level' => "$D4Lebel" ,'d1_level' => "$D1Lebel",'d3_level' => "$D3Lebel"];							
							$options = [  ];  //'sort' => ['created_date' => -1],'limit'=> 1
							$qry = new MongoDB\Driver\Query($filter,$options);
							$date = date("Y-m-d H:i:s");
							$rowsExtension = $mongo->executeQuery("admin.user_assign", $qry); 
							...
							$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
							$bulk = new MongoDB\Driver\BulkWrite;
							$filter = [ 'd4_level' => "$D4Lebel" ,'d2_level' => "$D2Lebel",'d3_level' => "$D3Lebel"];							
							$options = [  ];  //'sort' => ['created_date' => -1],'limit'=> 1
							$qry = new MongoDB\Driver\Query($filter,$options);
							$date = date("Y-m-d H:i:s");
							$rowsExtension = $mongo->executeQuery("admin.user_assign", $qry); 
