		...
		?>
          ...
          <li class="treeview">
           ...
           <ul class="treeview-menu">
			...
			<a href="group_hourly_stats.php"><i class="fa fa-circle-o"></i><?php echo _QXZ("Group Hourly Report"); ?></a></li>
              <li><a href="user_group_bulk_change.php"><i class="fa fa-circle-o"></i><?php echo _QXZ("Bulk Group Change"); ?></a></li>
			<a href="<?php echo $ADMIN ?>?ADD=12000"><i class="fa fa-circle-o"></i><?php echo _QXZ("Show Extension Groups"); ?></a></li>
              <li>
			...
			<?php  }
              ...
              <li>
               <?php } ?>        <li><a href="<?php echo $ADMIN ?>?ADD=10000"><i class="fa fa-circle-o"></i><?php echo _QXZ("Show Remote Agents"); ?></a></li>
              <li>
