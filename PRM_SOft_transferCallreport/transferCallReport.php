...
<html>
<head>
 <title>Transferred Call Report</title>
    ...
    $('#datatable').DataTable( {
		...
		"dom": "1Bfrtip",
		 ...
		 'pageLength',
            ...
            {
                extend: 'csv',
				title:'TransferredCall_Report_'+today
...
<br><br>
	<div class="row">
		<font style="font-size:25px; margin-left:15px; color:#36457E;font-weight: 700;">Transferred Call Report</font>
	</div>
	...
	<br><br>
			<div class="col-md-12">
				<div>
					...
					<tbody>
						<tr>
							<td style="width: 25%;">&nbsp;&nbsp;From:&nbsp;&nbsp;<input type="date" id="min" name="min"><!--&nbsp;&nbsp;<input type="text" id="min_time" name="min_time" SIZE="9" MAXLENGTH="8" value="" placeholder="00:00:00">--></td>
							<td style="width: 25%;">To:&nbsp;&nbsp;<input type="date" id="max" name="max"><!--&nbsp;&nbsp;<input type="text" id="max_time" name="max_time" SIZE="9" MAXLENGTH="8" value=""  placeholder="23:59:59">--></td>
			   ...
			   <?php
				...
				?>
					...
					if (isset($_POST["btn_submit"]) == "btn_submit") {
					                    ...
					                    $sel_DropCall = "select dateT,customerno,agentno,status,extensionDID from log_after where dateT >='$start_date 00:00:00' and dateT <= '$end_date 23:59:59'  ORDER by `dateT` DESC ";
										//echo   $sel_DropCall;
										//echo "<br>";
										$res_DropCall = mysqli_query($db,$sel_DropCall);
									...
									?>    
                                        <tr>
											...
											<td><?php echo $row['extensionDID'];?></td>
