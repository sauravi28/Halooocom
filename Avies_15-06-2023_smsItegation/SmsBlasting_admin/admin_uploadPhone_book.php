...
if (isset($_GET["field17"]))			{$field17=$_GET["field17"];}
	elseif (isset($_POST["field17"]))	{$field17=$_POST["field17"];}
if (isset($_GET["field18"]))			{$field18=$_GET["field18"];}
	elseif (isset($_POST["field18"]))	{$field18=$_POST["field18"];}
...
$vicidial_list_fields = '|lead_id|vendor_lead_code|source_id|list_id|gmt_offset_now|called_since_last_reset|phone_code|phone_number|title|first_name|middle_initial|last_name|address1|address2|address3|city|state|province|postal_code|country_code|gender|date_of_birth|alt_phone|email|security_phrase|comments|called_count|last_local_call_time|rank|owner|entry_list_id|field1|field2|field3|field4|field5|field6|field7field8|field9|field10|field11|field12|field13|field14|field15|field16|field17|field18|field19|field20|field21|field22|field23|field24|field25|field26|field27|field28|field29|field30|field31|field32|field33|field34|field35|field36|field37|field38|field39|field40';
...
<title><?php echo _QXZ("ADMINISTRATION: SMS"); ?></title>
</head>
...
echo "<section style='margin-top:-39px;' class='content-header'>          <h1 style='font-size:23px; color:#4a4a4a;'>            "._QXZ("ADD PHONE NUMBERS")."          </h1>       </section>";
 
echo "<center class='mgg'><br><TABLE CELLPADDING=4 CELLSPACING=0><TR><TD>";
...
if ( (!$OK_to_process) or ( ($leadfile) and ($file_layout!="standard" && $file_layout!="template") ) )
	...
	if ($file_layout!="custom") 
		{
		?>		<table align=center width="1150" border=0 cellpadding=9 cellspacing=0 bgcolor=#a5d26b style="display:none;">

		  <tr>
			<td align=right width="35%" class="bgcolor_004"><B><font face="arial, helvetica" ><?php echo _QXZ("Load leads from this file"); ?>:</font></B></td>
			<td align=left width="65%"><input type=file name="leadfile" value="<?php echo $leadfile ?>"> 
			<?php  //echo "$NWB#list_loader$NWE"; ?></td>
		  </tr>
		  <tr>
			<td align=right class="bgcolor_004" width="25%"><font face="arial, helvetica" ><?php echo _QXZ("List ID Override"); ?>: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" >
			<select name='list_id_override' onchange="PopulateStatuses(this.value)" style='width:420px;'>
		  ...
		  <tr>
			<td align=right width="25%" class="bgcolor_004"><font face="arial, helvetica" ><?php echo _QXZ("Phone Code Override"); ?>: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" >
			<select name='phone_code_override' style='width:420px;'>
                        <option value='in_file' selected='yes'><?php echo _QXZ("Load from Lead File"); ?></option>
			<?php
		  ...
		  <tr>
			<td align=right class="bgcolor_004"><B><font face="arial, helvetica" ><?php echo _QXZ("File layout to use"); ?>:</font></B></td>
			<td align=left><font face="arial, helvetica" ><input type=radio name="file_layout" value="standard" checked><?php echo _QXZ("Standard Format"); ?>&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom"><?php echo _QXZ("Custom layout"); ?>&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="template"><?php echo _QXZ("Custom Template"); ?> <?php echo "$NWB#list_loader-file_layout$NWE"; ?></td>
		  </tr>
		  <tr>
			<td align=right width="25%" class="bgcolor_004"><font face="arial, helvetica" ><?php echo _QXZ("Custom Layout to Use"); ?>: </font></td>
			<td align=left><select name="template_id" id="template_id" style='width:420px;'>
<?php
...
?>
		  ...
		  <tr>
			<td align=right width="25%" class="bgcolor_004"><font face="arial, helvetica" ><?php echo _QXZ("Lead Duplicate Check"); ?>: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" ><select size=1 name=dupcheck style='width:420px;'>
	...
	<tr>
		<td width='25%' align="right" class="bgcolor_004"><font><?php echo _QXZ("Status Duplicate Check"); ?>:</font></td>
		<td width='75%'>
		<span id='statuses_display'>
			<select id='dedupe_statuses' name='dedupe_statuses[]' size=5 multiple style='width:420px;'>
		  ...
		  <tr>
			<td align=right width="25%" class="bgcolor_004"><font face="arial, helvetica" ><?php echo _QXZ("USA-Canada Check"); ?>: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" ><select size=1 name=usacan_check style='width:420px;'>
		  ...
		  <tr>
			<td align=right width="25%" class="bgcolor_004"><font face="arial, helvetica" ><?php echo _QXZ("Lead Time Zone Lookup"); ?>: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" ><select size=1 name=postalgmt style='width:420px;'>
		  ...
		  <tr>
			<td align=right width="25%" class="bgcolor_004"><font face="arial, helvetica" ><?php echo _QXZ("State Abbreviation Lookup"); ?>: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" ><select size=1 name=state_conversion style='width:420px;'>
		...
		<tr>
			<td align=center colspan=2><input class='btn bg-navy margin' type=submit value="<?php echo _QXZ("SUBMIT"); ?>" name='submit_file'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button class='btn bg-navy margin'onClick="javascript:document.location='admin_listloader_fourth_gen.php'" value="<?php echo _QXZ("START OVER"); ?>" name='reload_page'></td>
		  </tr>
		  <tr><td align=left><font > &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent"><?php echo _QXZ("BACK TO ADMIN"); ?></a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="./admin_listloader_third_gen.php"><?php echo _QXZ("Old Lead Loader"); ?></a> &nbsp; &nbsp; </font></td><td align=right><font><?php echo _QXZ("LIST LOADER 4th Gen"); ?>- &nbsp; &nbsp; <?php echo _QXZ("VERSION"); ?>: <?php echo $version ?> &nbsp; &nbsp; <?php echo _QXZ("BUILD"); ?>: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
		</table>
		<?php 
	...
	{
	?>
	<table align=center width="1150" border=0 cellpadding=9 cellspacing=0 bgcolor=#FFF2BF>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" ><?php echo _QXZ("Lead file"); ?>:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica"><?php echo $leadfile_name ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" ><?php echo _QXZ("List ID Override"); ?>:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" ><?php echo $list_id_override ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" ><?php echo _QXZ("Phone Code Override"); ?>:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" ><?php echo $phone_code_override ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" ><?php echo _QXZ("USA-Canada Check"); ?>:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" ><?php echo $usacan_check ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" ><?php echo _QXZ("Lead Duplicate Check"); ?>:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" ><?php echo $dupcheck ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" ><?php echo _QXZ("Lead Time Zone Lookup"); ?>:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" ><?php echo $postalgmt ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica"><?php echo _QXZ("State Abbreviation Lookup"); ?>:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" ><?php echo $state_conversion ?></font></td>
	</tr>


	<tr>
	<td align=center colspan=2><B><font face="arial, helvetica" >
	...
	if (count($field_check)>=2) 
		...
		while (!feof($file)) 
			...
			if (strlen($buffer)>0) 
			    ...
			    $field1 =				eregi_replace($field_regx, "", $field1);
				$field2 =				eregi_replace($field_regx, "", $field2);
				$field3 =				eregi_replace($field_regx, "", $field3);
				$field4 =				eregi_replace($field_regx, "", $field4);
				$field5 =				eregi_replace($field_regx, "", $field5);
				$field6 =				eregi_replace($field_regx, "", $field6);
				$field7 =				eregi_replace($field_regx, "", $field7);
				$field8 =				eregi_replace($field_regx, "", $field8);
				$field9 =				eregi_replace($field_regx, "", $field9);
				$field10 =				eregi_replace($field_regx, "", $field10);
				
			    $field11 =				eregi_replace($field_regx, "", $field11);
				$field12 =				eregi_replace($field_regx, "", $field12);
				$field13 =				eregi_replace($field_regx, "", $field13);
				$field14 =				eregi_replace($field_regx, "", $field14);
				$field15 =				eregi_replace($field_regx, "", $field15);
				$field16 =				eregi_replace($field_regx, "", $field16);
				$field17 =				eregi_replace($field_regx, "", $field17);
				$field18 =				eregi_replace($field_regx, "", $field18);
				$field19 =				eregi_replace($field_regx, "", $field19);
				$field20 =				eregi_replace($field_regx, "", $field20);
				
				$field21 =				eregi_replace($field_regx, "", $field21);
				$field22 =				eregi_replace($field_regx, "", $field22);
				$field23 =				eregi_replace($field_regx, "", $field23);
				$field24 =				eregi_replace($field_regx, "", $field24);
				$field25 =				eregi_replace($field_regx, "", $field25);
				$field26 =				eregi_replace($field_regx, "", $field26);
				$field27 =				eregi_replace($field_regx, "", $field27);
				$field28 =				eregi_replace($field_regx, "", $field28);
				$field29 =				eregi_replace($field_regx, "", $field29);
				$field30 =				eregi_replace($field_regx, "", $field30);
				
				$field31 =				eregi_replace($field_regx, "", $field31);
				$field32 =				eregi_replace($field_regx, "", $field32);
				$field33 =				eregi_replace($field_regx, "", $field33);
				$field34 =				eregi_replace($field_regx, "", $field34);
				$field35 =				eregi_replace($field_regx, "", $field35);
				$field36 =				eregi_replace($field_regx, "", $field36);
				$field37 =				eregi_replace($field_regx, "", $field37);
				$field38 =				eregi_replace($field_regx, "", $field38);
				$field39 =				eregi_replace($field_regx, "", $field39);
				$field40 =				eregi_replace($field_regx, "", $field40);
				...
				if ( ($valid_number>0) and ($dup_lead<1) and ($list_id >= 100 ))
					...
					if (strlen($custom_SQL)>3)
						{
						$stmtZ = "INSERT INTO vicidial_list (lead_id,entry_date,modify_date,status,user,vendor_lead_code,source_id,list_id,gmt_offset_now,called_since_last_reset,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,called_count,last_local_call_time,rank,owner,entry_list_id,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18,field19,field20,field21,field22,field23,field24,field25,field26,field27,field28,field29,field30,field31,field32,field33,field34,field35,field36,field37,field38,field39,field40) values('',\"$entry_date\",\"$modify_date\",\"$status\",\"$user\",\"$vendor_lead_code\",\"$source_id\",\"$list_id\",\"$gmt_offset\",\"$called_since_last_reset\",\"$phone_code\",\"$phone_number\",\"$title\",\"$first_name\",\"$middle_initial\",\"$last_name\",\"$address1\",\"$address2\",\"$address3\",\"$city\",\"$state\",\"$province\",\"$postal_code\",\"$country_code\",\"$gender\",\"$date_of_birth\",\"$alt_phone\",\"$email\",\"$security_phrase\",\"$comments\",0,\"2008-01-01 00:00:00\",\"$rank\",\"$owner\",'$list_id',\"$field1\",\"$field2\",\"$field3\",\"$field4\",\"$field5\",\"$field6\",\"$field7\",\"$field8\",\"$field9\",\"$field10\",\"$field11\",\"$field12\",\"$field13\",\"$field14\",\"$field15\",\"$field16\",\"$field17\",\"$field18\",\"$field19\",\"$field20\",\"$field21\",\"$field22\",\"$field23\",\"$field24\",\"$field25\",\"$field26\",\"$field27\",\"$field28\",\"$field29\",\"$field30\",\"$field31\",\"$field32\",\"$field33\",\"$field34\",\"$field35\",\"$field36\",\"$field37\",\"$field38\",\"$field39\",\"$field40\");";
						...
						if ($multi_insert_counter > 8) 
							...
							$stmtZ = "INSERT INTO vicidial_list (lead_id,entry_date,modify_date,status,user,vendor_lead_code,source_id,list_id,gmt_offset_now,called_since_last_reset,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,called_count,last_local_call_time,rank,owner,entry_list_id,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18,field19,field20,field21,field22,field23,field24,field25,field26,field27,field28,field29,field30,field31,field32,field33,field34,field35,field36,field37,field38,field39,field40) values$multistmt('',\"$entry_date\",\"$modify_date\",\"$status\",\"$user\",\"$vendor_lead_code\",\"$source_id\",\"$list_id\",\"$gmt_offset\",\"$called_since_last_reset\",\"$phone_code\",\"$phone_number\",\"$title\",\"$first_name\",\"$middle_initial\",\"$last_name\",\"$address1\",\"$address2\",\"$address3\",\"$city\",\"$state\",\"$province\",\"$postal_code\",\"$country_code\",\"$gender\",\"$date_of_birth\",\"$alt_phone\",\"$email\",\"$security_phrase\",\"$comments\",0,\"2008-01-01 00:00:00\",\"$rank\",\"$owner\",'0',\"$field1\",\"$field2\",\"$field3\",\"$field4\",\"$field5\",\"$field6\",\"$field7\",\"$field8\",\"$field9\",\"$field10\",\"$field11\",\"$field12\",\"$field13\",\"$field14\",\"$field15\",\"$field16\",\"$field17\",\"$field18\",\"$field19\",\"$field20\",\"$field21\",\"$field22\",\"$field23\",\"$field24\",\"$field25\",\"$field26\",\"$field27\",\"$field28\",\"$field29\",\"$field30\",\"$field31\",\"$field32\",\"$field33\",\"$field34\",\"$field35\",\"$field36\",\"$field37\",\"$field38\",\"$field39\",\"$field40\");";
							$rslt=mysql_to_mysqli($stmtZ, $link);
							if ($webroot_writable > 0) 
								{fwrite($stmt_file, $stmtZ."\r\n");}
							$multistmt='';
					...
					if ($bad < 1000000)
						...
						if ( $list_id < 100 )
							{
							print "<BR></b><font color=red>"._QXZ("record")." $total "._QXZ("BAD- PHONE").": $phone_number "._QXZ("ROW").": |$row[0]| "._QXZ("INVALID LIST ID")."</font><b>\n";
							}
						else
							{
							if ($valid_number < 1)
								{
								print "<BR></b><font color=red>"._QXZ("record")." $total "._QXZ("BAD- PHONE").": $phone_number "._QXZ("ROW").": |$row[0]| "._QXZ("INV").": $phone_number</font><b>\n";
								}
							else
								{
								print "<BR></b><font color=red>"._QXZ("record")." $total "._QXZ("BAD- PHONE").": $phone_number "._QXZ("ROW").": |$row[0]| "._QXZ("DUP").": $dup_lead  $dup_lead_list</font><b>\n";
								}
							}
						}
					$bad++;
		...
		if ($multi_insert_counter!=0) 
			{
			$stmtZ = "INSERT INTO vicidial_list (lead_id,entry_date,modify_date,status,user,vendor_lead_code,source_id,list_id,gmt_offset_now,called_since_last_reset,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,called_count,last_local_call_time,rank,owner,entry_list_id,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18,field19,field20,field21,field22,field23,field24,field25,field26,field27,field28,field29,field30,field31,field32,field33,field34,field35,field36,field37,field38,field39,field40) values".substr($multistmt, 0, -1).";";
		...
		if (count($field_check)>=2) 
			...
			while (!feof($file)) 
				...
				if (strlen($buffer)>0) 
					...
					$email =				preg_replace("/$field_regx/i", "", $email);
					$security_phrase =		preg_replace("/$field_regx/i", "", $security_phrase);
					$comments =				preg_replace("/$field_regx/i", "", $comments);										$field1 =				preg_replace("/$field_regx/i", "", $field1);					$field2 =				preg_replace("/$field_regx/i", "", $field2);					$field3  =				preg_replace("/$field_regx/i", "", $field3);					$field4 =				preg_replace("/$field_regx/i", "", $field4);					$field5  =				preg_replace("/$field_regx/i", "", $field5);					$field6  =				preg_replace("/$field_regx/i", "", $field6);					$field7  =				preg_replace("/$field_regx/i", "", $field7);					$field8  =				preg_replace("/$field_regx/i", "", $field8);					$field9  =				preg_replace("/$field_regx/i", "", $field9);					$field10  =				preg_replace("/$field_regx/i", "", $field10);										$field11 =				preg_replace("/$field_regx/i", "", $field11);					$field12 =				preg_replace("/$field_regx/i", "", $field12);					$field13  =				preg_replace("/$field_regx/i", "", $field13);					$field14 =				preg_replace("/$field_regx/i", "", $field14);					$field15  =				preg_replace("/$field_regx/i", "", $field15);					$field16  =				preg_replace("/$field_regx/i", "", $field16);					$field17  =				preg_replace("/$field_regx/i", "", $field17);					$field18  =				preg_replace("/$field_regx/i", "", $field18);					$field19  =				preg_replace("/$field_regx/i", "", $field19);					$field20  =				preg_replace("/$field_regx/i", "", $field20);										$field21 =				preg_replace("/$field_regx/i", "", $field21);					$field22 =				preg_replace("/$field_regx/i", "", $field22);					$field23  =				preg_replace("/$field_regx/i", "", $field23);					$field24 =				preg_replace("/$field_regx/i", "", $field24);					$field25  =				preg_replace("/$field_regx/i", "", $field25);					$field26  =				preg_replace("/$field_regx/i", "", $field26);					$field27  =				preg_replace("/$field_regx/i", "", $field27);					$field28  =				preg_replace("/$field_regx/i", "", $field28);					$field29  =				preg_replace("/$field_regx/i", "", $field29);					$field30  =				preg_replace("/$field_regx/i", "", $field30);										$field31 =				preg_replace("/$field_regx/i", "", $field31);					$field32 =				preg_replace("/$field_regx/i", "", $field32);					$field33  =				preg_replace("/$field_regx/i", "", $field33);					$field34 =				preg_replace("/$field_regx/i", "", $field34);					$field35  =				preg_replace("/$field_regx/i", "", $field35);					$field36  =				preg_replace("/$field_regx/i", "", $field36);					$field37  =				preg_replace("/$field_regx/i", "", $field37);					$field38  =				preg_replace("/$field_regx/i", "", $field38);					$field39  =				preg_replace("/$field_regx/i", "", $field39);					$field40  =				preg_replace("/$field_regx/i", "", $field40);										
					$rank =					preg_replace("/$field_regx/i", "", $rank);
					$owner =				preg_replace("/$field_regx/i", "", $owner);
				...
				if (strlen($buffer)>0) 
					...
					if ( ($valid_number>0) and ($dup_lead<1) and ($list_id >= 100 ))
						...
						if ($multi_insert_counter > 8) 
							{
							### insert good deal into pending_transactions table ###
							$stmtZ = "INSERT INTO vicidial_list (lead_id,entry_date,modify_date,status,user,vendor_lead_code,source_id,list_id,gmt_offset_now,called_since_last_reset,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,called_count,last_local_call_time,rank,owner,entry_list_id,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18,field19,field20,field21,field22,field23,field24,field25,field26,field27,field28,field29,field30,field31,field32,field33,field34,field35,field36,field37,field38,field39,field40 ) values$multistmt('',\"$entry_date\",\"$modify_date\",\"$status\",\"$user\",\"$vendor_lead_code\",\"$source_id\",\"$list_id\",\"$gmt_offset\",\"$called_since_last_reset\",\"$phone_code\",\"$phone_number\",\"$title\",\"$first_name\",\"$middle_initial\",\"$last_name\",\"$address1\",\"$address2\",\"$address3\",\"$city\",\"$state\",\"$province\",\"$postal_code\",\"$country_code\",\"$gender\",\"$date_of_birth\",\"$alt_phone\",\"$email\",\"$security_phrase\",\"$comments\",0,\"2008-01-01 00:00:00\",\"$rank\",\"$owner\",'0',\"$field1\",\"$field2\",\"$field3\",\"$field4\",\"$field5\",\"$field6\",\"$field7\",\"$field8\",\"$field9\",\"$field10\",\"$field11\",\"$field12\",\"$field13\",\"$field14\",\"$field15\",\"$field16\",\"$field17\",\"$field18\",\"$field19\",\"$field20\",\"$field21\",\"$field22\",\"$field23\",\"$field24\",\"$field25\",\"$field26\",\"$field27\",\"$field28\",\"$field29\",\"$field30\",\"$field31\",\"$field32\",\"$field33\",\"$field34\",\"$field35\",\"$field36\",\"$field37\",\"$field38\",\"$field39\",\"$field40\");";
							$rslt=mysql_to_mysqli($stmtZ, $link);
							if ($webroot_writable > 0) 
								{fwrite($stmt_file, $stmtZ."\r\n");}
							$multistmt='';
						...
						if ($bad < 1000000)
							...
							if ( $list_id < 100 )
								{
								print "<BR></b><font  color=red>record $total "._QXZ("BAD- PHONE").": $phone_number "._QXZ("ROW").": |$row[0]| "._QXZ("INVALID LIST ID")."</font><b>\n";
								}
							else
								{
								if ($valid_number < 1)
									{
									print "<BR></b><font  color=red>record $total "._QXZ("BAD- PHONE").": $phone_number "._QXZ("ROW").": |$row[0]| "._QXZ("INV")."($invalid_reason): $phone_number</font><b>\n";
									}
								else
									{
									print "<BR></b><font  color=red>record $total "._QXZ("BAD- PHONE").": $phone_number "._QXZ("ROW").": |$row[0]| "._QXZ("DUP").": $dup_lead  $dup_lead_list</font><b>\n";
									}
								}
							}
						$bad++;
...
?>
</form><?php // Get status messageif(!empty($_GET['status'])){    switch($_GET['status']){        case 'succ':            $statusType = 'alert-success';            $statusMsg = 'Data has been imported successfully.';            break;        case 'err':            $statusType = 'alert-danger';            $statusMsg = 'Some problem occurred, please try again.';            break;        case 'invalid_file':            $statusType = 'alert-danger';            $statusMsg = 'Please upload a valid CSV file.';            break;        default:            $statusType = '';            $statusMsg = '';    }}?><!-- Display status message --><?php if(!empty($statusMsg)){ ?><div class="col-xs-12">    <div class="alert <?php echo $statusType; ?>"><?php echo $statusMsg; ?></div></div><?php } ?><div class="row">    <!-- Import link -->    <div class="col-md-12 head">	        <div class="float-right">            <label for="Upload leads">Upload Numbers:</label>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm');" style="background-color: #6eba01;border-color:#6eba01;"><i class="plus"></i> Import CSV file</a>        </div>    </div>    <!-- CSV file upload form -->    <div class="col-md-12" id="importFrm" style="display: none;">        <form action="importPhoneBookData.php" method="post" enctype="multipart/form-data">            <br><input type="file" name="file" /><input type="submit" class="btn" name="importSubmit" value="Submit" style="position: relative;top: -27px;left: 280px;background-color: #36457E !important;color: #FFFF;">        </form>    </div></div><br><br><div class="row">    <!-- Import link -->    <div class="col-md-12 head">	        <div class="float-right">            <label for="Upload leads">Send SMS</label>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="btn btn-success" onclick="formToggle1('importFrm1');" style="background-color: #6eba01;border-color:#6eba01;"><i class="plus"></i> Click</a>        </div>    </div>    <!-- CSV file upload form -->    <div class="col-md-12" id="importFrm1" style="display: none;">        <form action="" method="post">            <br> <label for="Upload leads">Message</label>&nbsp;<input type="text" name="sendSubmit"  placeholder="Enter your message" required><br>			<input type="submit" class="btn" name="Submit"  style="position: relative;top: -25px;left: 280px;background-color: #36457E !important;color: #FFFF;">        </form>    </div></div><!-- Show/hide CSV upload form --><script>function formToggle(ID){    var element = document.getElementById(ID);    if(element.style.display === "none"){        element.style.display = "block";    }else{        element.style.display = "none";    }}function formToggle1(ID){    var element = document.getElementById(ID);    if(element.style.display === "none"){        element.style.display = "block";    }else{        element.style.display = "none";    }}</script><?phprequire('dbconnect_mysqli.php');if(isset($_POST["Submit"])){	$textmessage = $_POST["sendSubmit"];//echo $message;$sel_data = "select phone_number from sms_blasting";$result = mysqli_query($link,$sel_data);while($row = mysqli_fetch_assoc($result)) {$txt_sms_no = $row["phone_number"];$SmsNo = "+91".$txt_sms_no;$txt_Msg = urlencode($textmessage);$url = "http://mobicomm.dove-sms.com//submitsms.jsp?user=AviesPub&key=93a39697ecXX&mobile=".$SmsNo."&message=".$txt_Msg."&senderid=AVIESP&accusage=1&entityid=1701158053992275676&tempid=1707162634760436088";//echo $url;$ch=curl_init($url);curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);$curl_scraped_page=curl_exec($ch);curl_close($ch);$resp1= $curl_scraped_page;$response=print_r($resp1,true);//echo "\nRESPONSE:\n".$resp1;echo "<br/>";//echo "<br/>";$stmt = "insert into sms_report(phone_number,message,status) VALUES('$SmsNo','$textmessage','$resp1')";$success = mysqli_query($link,$stmt);}echo '<script>alert("Message Sent Successfully")</script>';$del = "DELETE FROM `sms_blasting` WHERE phone_number like '%'";$del1 = mysqli_query($link,$del); }exit;?>
</html>
