...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #1A2B6D; color:white;">
    ...
    <a href="../../index.php" class="brand-link" style="background-color: #1A2B6D; color:white;">
      ...
      <span class="brand-text font-weight-light" style="color:#1A2B6D;">User Stats</span>
    </a>
            ...
            <br><br>
			  <?php
				...
				?>
					...
					<br>
					<label style="font-size: medium;font-weight: 400;">User Name :  <?php echo $user;?></label>
					<br><br>
					<label style="font-size: medium;font-weight: 400;"><b>AGENT LOGIN/LOGOUT TIME</b></label>
            ...
            <div class="card-body p-0">
             ...
             <tbody>
			  <?php 	
							...
							$stmt_login="SELECT `status`,`created_date`,`campaign`,`id` FROM `user_log` WHERE `status` in ('LOGIN','LOGOUT') and user='$user' and created_date >='$start_date 00:00:00' and created_date <='$end_date 23:59:59'";
                            //echo $stmt_login;
						   //die;
							  ...
							  while($row = mysqli_fetch_assoc($rslt_login)) {
								...
								if($status == "LOGOUT"){
									  ...
									  $stmt1="SELECT `created_date` FROM `user_log` WHERE id='$id'";
									  $rslt1= mysqli_query($conn,$stmt1);
									  $row1= mysqli_fetch_row($rslt1);
							          $Date1 = $row1[0];
									  
									  $stmt2="SELECT `id`,`created_date` FROM `user_log` WHERE `status`='LOGIN' and user='$user' and created_date < '$Date1' ORDER BY created_date DESC LIMIT 1";
									  ...
									  $duration = $interval->format('%H:%I:%S');
										  ...
										  $duration ="";
												...
												?>
											<tr>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $created_date; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $status; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $campaign; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $duration; ?></td>
										    </tr>							
		...
		<div class="card card-default">
          <div class="card-header">
            <br><br>
			  <?php
				...
				?>
					<label style="font-size: medium;font-weight: 400;"><b>OUTBOUND CALLS FOR THIS TIME PERIOD</b></label>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
            <div class="card-body p-0">
             <table class="table m-0" id="table_out" cellspacing="0" style="border: 1px solid #eee;">
              <thead>
                  <tr>
					   <th class="col-xs-4" style="text-align: center;">
                        DATE & TIME
			    ...
			    <tbody>
			        <?php 	
							 ...
							 if ($start_date !="" && $end_date !="") {
							   ...
							   $stmt="SELECT extension_id from users where user_name='$user';";
	                           $rslt= mysqli_query($conn,$stmt);
	                           $row= mysqli_fetch_row($rslt);
							   $agent_ext = $row[0];
								 
							$stmt_login="SELECT `status`,`calledid`,`dial_time`,`duration`,`campaign` FROM `call_log` WHERE `agent`='$agent_ext' and `calltype` in('CLICK','OUTBOUND') and dial_time >='$start_date 00:00:00' and dial_time <='$end_date 23:59:59'";
                           //echo $stmt_login;
						   //die;
	                           $rslt_login= mysqli_query($conn,$stmt_login);
							  ...
							  while($row = mysqli_fetch_assoc($rslt_login)) {
								  ...
								  $phoneno = $row["calledid"];
								  $created_date = $row["dial_time"];
								  $campaign = $row["campaign"];
							...
							?>
											<tr>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $created_date; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $Time; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $phoneno; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $status; ?></td>
											  <td class="col-xs-4" style="text-align: center;"><?php echo $campaign; ?></td>
										    </tr>							
		...
		<div class="card card-default">
          <div class="card-header">
            <br><br>
			  <?php
				...
				?>
					<label style="font-size: medium;font-weight: 400;"><b>INBOUND/CLOSER CALLS FOR THIS TIME PERIOD</b></label>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
            <div class="card-body p-0">
             <table class="table m-0" id="table_in" cellspacing="0" style="border: 1px solid #eee;">
              <thead>
                  <tr>
					   <th class="col-xs-4" style="text-align: center;">
                        DATE & TIME
			    ...
			    <tbody>
			        <?php 	
							 ...
							 if ($start_date !="" && $end_date !="") {
							   ...
							   $stmt_1="SELECT extension_id from users where user_name='$user';";
	                           $rslt_1= mysqli_query($conn,$stmt_1);
	                           $row_1= mysqli_fetch_row($rslt_1);
							   $agent_ext_1 = $row_1[0];
								 
							$stmt_login_1="SELECT `status`,`calledid`,`dial_time`,`duration`,`campaign` FROM `call_log` WHERE `agent`='$agent_ext_1' and `calltype`='INBOUND' and dial_time >='$start_date 00:00:00' and dial_time <='$end_date 23:59:59'";
                           //echo $stmt_login_1;
						   //die;
	                           $rslt_login_1= mysqli_query($conn,$stmt_login_1);
	                         
							  
							  while($row_2 = mysqli_fetch_assoc($rslt_login_1)) {
								  
								  $phoneno = $row_2["calledid"];
								  $created_date = $row_2["dial_time"];
								  $campaign = $row_2["campaign"];
								  $duration = $row_2["duration"];
								  $status = $row_2["status"];
    ...
    $('#table_camp').DataTable( {
		...
		"dom": "1Bfrtip",
		 ...
		 'pageLength',
            ...
            {
                extend: 'csv',
				title:'Agent_login_logout_Report_'+date
	...
	$('#table_out').DataTable( {
		...
		"dom": "1Bfrtip",
		 ...
		 'pageLength',
            ...
            {
                extend: 'csv',
				title:'Agent_outboundCall_Report_'+date
	...
	$('#table_in').DataTable( {
		...
		"dom": "1Bfrtip",
		 ...
		 'pageLength',
            ...
            {
                extend: 'csv',
				title:'Agent_inboundCall_Report_'+date
