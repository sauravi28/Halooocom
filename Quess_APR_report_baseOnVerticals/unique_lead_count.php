...
############################################super admin 
	...
	$superAdminArr = array();
	if($D1_UserArray[0]['user_level'] == 'SuperAdmin'){
			date_default_timezone_set('asia/kolkata');
		$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
		$bulk = new MongoDB\Driver\BulkWrite;
		$filter = [];							
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">UNIQUE LEAD COUNT REPORT</h3>
            <br><br>
			  <?php
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
                 <div class="card-body p-0">
             <table class="table m-0 tableFixHead" id="table_camp" cellspacing="0" style="border: 1px solid #eee;width: 100%;"><!--tableFixHead-->
              <thead>
                  <tr>
											...
											for($n=0;$n<count($uniqueNumbers);$n++){
												$phoneNumberCountArray = array();	
													...
													$customerno = $uniqueNumbers[$n];
														...
														$options = []; 
														$qry_Recruiter = new MongoDB\Driver\Query($filter,$options);
														$date = date("Y-m-d H:i:s");
														$rows_Recruiter = $mongo->executeQuery("candidateinfo.outbound", $qry_Recruiter); 
														$arr_Recruiter = $rows_Recruiter->toArray();
														$array_Recruiter= json_decode(json_encode($arr_Recruiter), true);							        
														$Recruiter = $array_Recruiter[0]['user'];
														...
														$leadsource = $array_phoneNumber[0]['lead_source'];
												...
												$phoneNumberCount = count($phoneNumberCountArray); 
														...
														$exD1_User =  $rowsD1_User->toArray();
														$D1_UserArray = json_decode(json_encode($exD1_User), true);
														$d1_level = $D1_UserArray[0]['d1_level'];
														$d2_level = $D1_UserArray[0]['d2_level'];
														$d3_level = $D1_UserArray[0]['d3_level'];
														$VerticalName = $D1_UserArray[0]['vertical'];
													...
													/*	$mongo = new MongoDB\Driver\Manager("mongodb://localhost:27017");    
														$bulk = new MongoDB\Driver\BulkWrite;
														$filter = ["phone_number" => "$customerno",
														'$and' => [
																				['created_date' => ['$gt' => "$start_date 00:00:00"]],
																				['created_date' => ['$lt' => "$end_date 23:59:59"]]
																]	
														...
														$options = [ 'sort' => ['created_date' => -1],'limit'=> 1 ];  //
														$qry = new MongoDB\Driver\Query($filter,$options);													
														$rowsD1_User = $mongo->executeQuery("candidateinfo.candidate_Information", $qry); 
														$exD1_User1 =  $rowsD1_User->toArray();
														$D1_UserArray1 = json_decode(json_encode($exD1_User1), true);
														$leadsource = $D1_UserArray1[0]['lead_source'];  */
												    ...
												    <tr>
													 ...
													 <!-- <td class="col-xs-2" style="text-align: center;"><?php echo $x; ?></td>-->
													   <td class="col-xs-2" style="text-align: center;"><?php echo $selected_D4Option; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $FistName; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $VerticalName; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $d1_level; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $d2_level; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $d3_level; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $phoneNumber ; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $phoneNumberCount; ?></td>
													  <td class="col-xs-2" style="text-align: center;"><?php echo $leadsource; ?></td>
    ...
    $('#table_camp').DataTable( {
		...
		"order": [[0, 'asc']],
		 ...
		 'pageLength',
            ...
            {
                extend: 'csv',
				title:'Unique_lead_count_Report_'+today
