  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">OUT BOUND REPORT</h3>
            <br><br>
			  <?php
									...
									$mongo->executeBulkWrite('candidateinfo.repostStatus', $bulk);
											...
											foreach ($_POST['D4_User'] as $selected_D4Option) {
												...
												foreach($rows_talkTIme as $rows){
													...
													if(($rows->customerans == "Answered") &&  ($rows->disposition == '')){
														$callStatus = "Auto";
													}else if(($rows->customerans == "Answered") &&  ($rows->disposition != '')){
														$callStatus = $rows->disposition;
													}else if (($rows->customerans == "") &&  ($rows->disposition == '')){
														$callStatus = "No Answered";
													}
											  ...
											  <td class="col-xs-2" style="text-align: center;"><?php if($phoneNumber == ""){echo "NULL";}else{ echo $phoneNumber; }?></td>
											  <td class="col-xs-1" style="text-align: center;"><?php if($rows->customerans == ""){echo "No Answer";}else if($rows->customerans=="Answered"){ echo "Answer";} //$callStatus; ?></td> 
											  <td class="col-xs-2" style="text-align: center;"><?php if($rows->extensionans == ""){echo "No Answer";}else if($rows->extensionans=="Answered"){ echo "Answer";}?></td>
											  ...
											  <!--<td class="col-xs-1" style="text-align: center;"><?php //echo $rows->customerans; ?></td>-->
											  <?php if($rows->voice != ''){ ?>
												<td class="col-xs-1" style="text-align: center;"><a href="<?php echo "../../../voicefiles/".$rows->voice; ?>">Download</a>
