		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
					<img src="<?php echo $amp_conf['BRAND_IMAGE_TANGO_LEFT']; ?>" alt="<?php echo $amp_conf['BRAND_FREEPBX_ALT_LEFT']; ?>" title="HalooPBX" id="MENU_BRAND_IMAGE_TANGO_LEFT" data-BRAND_IMAGE_FREEPBX_LINK_LEFT="https://haloocom.com/" />
				</a>
			</div>
