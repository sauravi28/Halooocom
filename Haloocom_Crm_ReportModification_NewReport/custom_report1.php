    ...
    var table = $('#example').DataTable({
		...
		"order": [[ 0, "desc" ]],
		 ...
		 'pageLength',
            ...
            {
                extend: 'excelHtml5',
				title:'detail_report_excel_'+today
                
            },
            {
                extend: 'pdfHtml5',
				title:'detail_report_pdf_'+today
            }
...
$(document).ready(function() {
    ...
    $('#example').DataTable( {
        initComplete: function () {
            this.api().columns('2,3,8,10').every( function () {
                var column = this;
	...
	<div>
        ...
        <thead>
            <tr>
                ...
                <th class="thclass" style="font-family:Nunito Sans,sans-serif;font-size: 0.875rem;">Category</th>				
			...
			<tbody>
				<?php 
					...
					//	echo $id;
						...
						$sql_endDate = "SELECT CONVERT_TZ(`end_date_c`,'+00:00','+05:30') as end_datetime,case_type_c,category_c  FROM `cases_cstm` WHERE `id_c` = '$id'";
						$res_endDate = mysqli_query($link,$sql_endDate);
						$row_endDate = mysqli_fetch_array($res_endDate);
						$case_type_c = $row_endDate['case_type_c'];
						$category = $row_endDate['category_c'];
